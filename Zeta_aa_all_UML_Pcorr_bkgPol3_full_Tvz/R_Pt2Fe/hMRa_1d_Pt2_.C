...
//=========  (Mon Jun 11 23:29:28 2018) by ROOT version 6.12/06
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(-0.1875,0.3898402,1.6875,0.8725675);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Fe__1->SetBinContent(1,0.5111734);
   hMR_Fe__1->SetBinContent(2,0.6741946);
   hMR_Fe__1->SetBinContent(3,0.5189281);
   hMR_Fe__1->SetBinContent(4,0.6082053);
   hMR_Fe__1->SetBinContent(5,0.723822);
   hMR_Fe__1->SetBinError(1,0.04470468);
   hMR_Fe__1->SetBinError(2,0.09619061);
   hMR_Fe__1->SetBinError(3,0.06330125);
   hMR_Fe__1->SetBinError(4,0.05548928);
   hMR_Fe__1->SetBinError(5,0.08208311);
   hMR_Fe__1->SetEntries(367.6691);
