...
//=========  (Mon Jun 11 23:31:08 2018) by ROOT version 6.12/06
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.4375,0.4905524,1.0625,1.346221);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C__1->SetBinContent(1,1.017431);
   hMR_C__1->SetBinContent(2,0.8545212);
   hMR_C__1->SetBinContent(3,0.9039262);
   hMR_C__1->SetBinContent(4,0.6965778);
   hMR_C__1->SetBinContent(5,0.8631901);
   hMR_C__1->SetBinError(1,0.2106261);
   hMR_C__1->SetBinError(2,0.1111558);
   hMR_C__1->SetBinError(3,0.1317911);
   hMR_C__1->SetBinError(4,0.08941387);
   hMR_C__1->SetBinError(5,0.1360959);
   hMR_C__1->SetEntries(186.8482);
   hMR_C__1->SetStats(0);
