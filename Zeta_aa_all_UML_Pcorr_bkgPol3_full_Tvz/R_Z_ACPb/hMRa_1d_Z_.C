...
//=========  (Mon Jun 11 23:31:14 2018) by ROOT version 6.12/06
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.4375,0.138884,1.0625,1.106032);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Pb__1->SetBinContent(1,0.766458);
   hMR_Pb__1->SetBinContent(2,0.5174351);
   hMR_Pb__1->SetBinContent(3,0.4075242);
   hMR_Pb__1->SetBinContent(4,0.5498549);
   hMR_Pb__1->SetBinContent(5,0.4447664);
   hMR_Pb__1->SetBinError(1,0.2060153);
   hMR_Pb__1->SetBinError(2,0.1368278);
   hMR_Pb__1->SetBinError(3,0.1368362);
   hMR_Pb__1->SetBinError(4,0.1047497);
   hMR_Pb__1->SetBinError(5,0.1139587);
   hMR_Pb__1->SetEntries(69.47509);
