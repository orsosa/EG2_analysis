...
//=========  (Mon Jun 11 23:31:13 2018) by ROOT version 6.12/06
   ...
   c->Range(0.4375,0.3628215,1.0625,2.102831);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C__1->SetBinContent(1,1.43363);
   hMR_C__1->SetBinContent(2,0.7809595);
   hMR_C__1->SetBinContent(3,0.9306363);
   hMR_C__1->SetBinContent(4,0.7508463);
   hMR_C__1->SetBinContent(5,0.8783817);
   hMR_C__1->SetBinError(1,0.4289143);
   hMR_C__1->SetBinError(2,0.1810074);
   hMR_C__1->SetBinError(3,0.1673383);
   hMR_C__1->SetBinError(4,0.1272893);
   hMR_C__1->SetBinError(5,0.2025585);
   hMR_C__1->SetEntries(75.49005);
   hMR_C__1->SetStats(0);
