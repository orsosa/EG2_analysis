...
//=========  (Wed Jun 20 07:10:09 2018) by ROOT version 6.12/06
   ...
   TH1D *hRq2_C_stack_1 = new TH1D("hRq2_C_stack_1","Q^{2} solid data",5, xAxis34);
   ...
   TH1D *hRq2_Fe_stack_2 = new TH1D("hRq2_Fe_stack_2","Q^{2} solid data",5, xAxis35);
   ...
   TH1D *hRq2_Pb_stack_3 = new TH1D("hRq2_Pb_stack_3","Q^{2} solid data",5, xAxis36);
