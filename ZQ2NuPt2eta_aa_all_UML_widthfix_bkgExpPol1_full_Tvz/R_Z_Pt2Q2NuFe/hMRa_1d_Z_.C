...
//=========  (Tue Apr 17 17:57:38 2018) by ROOT version 6.12/04
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.325,0.3711863,1.075,0.8816949);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Fe__1->SetBinContent(1,0.7198594);
   hMR_Fe__1->SetBinContent(2,0.587186);
   hMR_Fe__1->SetBinContent(3,0.5613837);
   hMR_Fe__1->SetBinContent(4,0.4998036);
   hMR_Fe__1->SetBinContent(5,0.5918474);
   hMR_Fe__1->SetBinContent(6,0.6468961);
   hMR_Fe__1->SetBinError(1,0.03555281);
   hMR_Fe__1->SetBinError(2,0.05988739);
   hMR_Fe__1->SetBinError(3,0.06856001);
   hMR_Fe__1->SetBinError(4,0.05904454);
   hMR_Fe__1->SetBinError(5,0.06427953);
   hMR_Fe__1->SetBinError(6,0.1643);
   hMR_Fe__1->SetEntries(294.5929);
