...
//=========  (Fri Mar 23 05:43:12 2018) by ROOT version5.34/34
   ...
   hMRatio->SetBinError(4,0.03867442);
   hMRatio->SetBinError(7,0.04024852);
   hMRatio->SetBinError(10,0.04192624);
   hMRatio->SetBinError(13,0.04084156);
   hMRatio->SetBinError(16,0.05240022);
   hMRatio->SetBinError(19,0.04585307);
