...
//=========  (Fri Mar 23 05:43:12 2018) by ROOT version5.34/34
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.325,0.4908917,1.075,1.48906);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C->SetBinContent(1,1.129652);
   hMR_C->SetBinContent(2,0.8626322);
   hMR_C->SetBinContent(3,0.7722159);
   hMR_C->SetBinContent(4,1.349416);
   hMR_C->SetBinContent(5,0.9066452);
   hMR_C->SetBinContent(6,0.6279519);
   hMR_C->SetBinError(1,0.0002331827);
   hMR_C->SetBinError(2,0.0004780327);
   hMR_C->SetBinError(3,0.0007915047);
   hMR_C->SetBinError(4,0.001801666);
   hMR_C->SetBinError(5,0.0006502991);
   hMR_C->SetBinError(6,0.001028564);
   hMR_C->SetEntries(6);
   hMR_C->SetStats(0);
