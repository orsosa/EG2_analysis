...
//=========  (Tue Apr 17 17:57:38 2018) by ROOT version 6.12/04
   ...
   c->Range(0.325,0.3148279,1.075,1.336201);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C__1->SetBinContent(1,0.893534);
   hMR_C__1->SetBinContent(2,0.8809296);
   hMR_C__1->SetBinContent(3,0.9147363);
   hMR_C__1->SetBinContent(4,0.7881225);
   hMR_C__1->SetBinContent(5,0.9355589);
   hMR_C__1->SetBinContent(6,0.6276405);
   hMR_C__1->SetBinError(1,0.07129398);
   hMR_C__1->SetBinError(2,0.3142248);
   hMR_C__1->SetBinError(3,0.1819296);
   hMR_C__1->SetBinError(4,0.114123);
   hMR_C__1->SetBinError(5,0.1346785);
   hMR_C__1->SetBinError(6,0.1736187);
   hMR_C__1->SetEntries(128.1723);
   hMR_C__1->SetStats(0);
