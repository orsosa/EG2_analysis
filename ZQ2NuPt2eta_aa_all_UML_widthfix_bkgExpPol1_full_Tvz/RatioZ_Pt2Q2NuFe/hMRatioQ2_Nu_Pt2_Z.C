...
//=========  (Fri Mar 23 05:43:01 2018) by ROOT version5.34/34
   ...
   hMRatio->SetBinError(4,0.01032882);
   hMRatio->SetBinError(7,0.01033504);
   hMRatio->SetBinError(10,0.0131224);
   hMRatio->SetBinError(13,0.0135394);
   hMRatio->SetBinError(16,0.0177397);
   hMRatio->SetBinError(19,0.02679006);
