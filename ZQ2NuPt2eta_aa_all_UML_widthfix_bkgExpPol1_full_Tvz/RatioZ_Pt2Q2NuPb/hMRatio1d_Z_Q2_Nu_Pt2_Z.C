...
//=========  (Fri Mar 23 05:43:05 2018) by ROOT version5.34/34
   ...
   c->Range(0.325,0.4083538,1.075,0.5449598);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Pb->SetBinContent(1,0.4325801);
   hMR_Pb->SetBinContent(2,0.5237256);
   hMR_Pb->SetBinContent(3,0.4802219);
   hMR_Pb->SetBinContent(4,0.4438031);
   hMR_Pb->SetBinContent(5,0.4345841);
   hMR_Pb->SetBinContent(6,0.4354368);
   hMR_Pb->SetBinError(1,0.001056975);
   hMR_Pb->SetBinError(2,0.002369605);
   hMR_Pb->SetBinError(3,0.004581819);
   hMR_Pb->SetBinError(4,0.001185525);
   hMR_Pb->SetBinError(5,0.003471137);
   hMR_Pb->SetBinError(6,0.008466137);
   hMR_Pb->SetEntries(6);
   hMR_Pb->SetStats(0);
