...
//=========  (Fri Mar 23 05:43:14 2018) by ROOT version5.34/34
   ...
   hMRatio->SetBinError(4,0.02070215);
   hMRatio->SetBinError(7,0.02504155);
   hMRatio->SetBinError(10,0.02402744);
   hMRatio->SetBinError(13,0.0253832);
   hMRatio->SetBinError(16,0.02751972);
   hMRatio->SetBinError(19,0.0354193);
