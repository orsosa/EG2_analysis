...
//=========  (Fri Mar 23 05:43:14 2018) by ROOT version5.34/34
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.325,0.3464761,1.075,0.8113246);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Pb->SetBinContent(1,0.5773757);
   hMR_Pb->SetBinContent(2,0.5147873);
   hMR_Pb->SetBinContent(3,0.4100454);
   hMR_Pb->SetBinContent(4,0.7470344);
   hMR_Pb->SetBinContent(5,0.4288835);
   hMR_Pb->SetBinContent(6,0.4409439);
   hMR_Pb->SetBinError(1,7.374492e-05);
   hMR_Pb->SetBinError(2,0.0001118519);
   hMR_Pb->SetBinError(3,0.0002191483);
   hMR_Pb->SetBinError(4,9.68534e-05);
   hMR_Pb->SetBinError(5,0.0001525879);
   hMR_Pb->SetBinError(6,0.0003082415);
   hMR_Pb->SetEntries(6);
   hMR_Pb->SetStats(0);
