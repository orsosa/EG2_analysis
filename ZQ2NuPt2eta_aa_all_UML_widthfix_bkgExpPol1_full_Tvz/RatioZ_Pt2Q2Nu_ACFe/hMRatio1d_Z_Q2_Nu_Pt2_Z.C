...
//=========  (Fri Mar 23 05:43:10 2018) by ROOT version5.34/34
   ...
   c->Range(0.325,0.3804075,1.075,1.023191);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Fe->SetBinContent(1,0.9342828);
   hMR_Fe->SetBinContent(2,0.527685);
   hMR_Fe->SetBinContent(3,0.4681544);
   hMR_Fe->SetBinContent(4,0.8203902);
   hMR_Fe->SetBinContent(5,0.5730366);
   hMR_Fe->SetBinContent(6,0.6457266);
   hMR_Fe->SetBinError(1,0.0001428437);
   hMR_Fe->SetBinError(2,0.001507316);
   hMR_Fe->SetBinError(3,0.0001475891);
   hMR_Fe->SetBinError(4,0.000283886);
   hMR_Fe->SetBinError(5,0.0002457071);
   hMR_Fe->SetBinError(6,0.0006272441);
   hMR_Fe->SetEntries(6);
   hMR_Fe->SetStats(0);
