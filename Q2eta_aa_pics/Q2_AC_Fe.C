...
//=========  (Wed Jun 20 01:51:20 2018) by ROOT version 6.12/06
   ...
   hac_s_px__9->SetBinContent(1,0.0220962);
   hac_s_px__9->SetBinContent(2,0.05022223);
   hac_s_px__9->SetBinContent(3,0.05788562);
   hac_s_px__9->SetBinContent(4,0.06830835);
   hac_s_px__9->SetBinContent(5,0.04103063);
   hac_s_px__9->SetBinError(1,0.002416225);
   hac_s_px__9->SetBinError(2,0.008277457);
   hac_s_px__9->SetBinError(3,0.007082855);
   hac_s_px__9->SetBinError(4,0.01724051);
   hac_s_px__9->SetBinError(5,0.01886827);
   hac_s_px__9->SetEntries(73.7763);
   ...
   hac_s_px__9->GetXaxis()->SetTitle("Q^{2} ((GeV^{2})");
