...
//=========  (Wed Jun 20 01:51:20 2018) by ROOT version 6.12/06
   ...
   gStyle->SetOptStat(0);
   c->Range(0.4833333,-158.1939,4.616667,1423.745);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetTickx(1);
   ...
   hs_px__5->SetBinContent(1,855.2779);
   hs_px__5->SetBinContent(2,1038.854);
   hs_px__5->SetBinContent(3,709.9553);
   hs_px__5->SetBinContent(4,452.3563);
   hs_px__5->SetBinContent(5,298.3044);
   hs_px__5->SetBinError(1,104.0396);
   hs_px__5->SetBinError(2,166.4327);
   hs_px__5->SetBinError(3,81.18295);
   hs_px__5->SetBinError(4,71.07614);
   hs_px__5->SetBinError(5,55.78043);
   hs_px__5->SetEntries(211.2378);
   hs_px__5->SetStats(0);
   ...
   hs_px__5->GetXaxis()->SetTitle("Q^{2} ((GeV^{2})");
