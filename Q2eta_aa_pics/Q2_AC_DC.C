...
//=========  (Wed Jun 20 01:51:20 2018) by ROOT version 6.12/06
   ...
   c->SetFrameBorderMode(0);
   Double_t xAxis4[6] = {1, 1.33, 1.66, 2, 2.5, 4.1}; 
   
   TH1D *hac_l_px__4 = new TH1D("hac_l_px__4","Acceptance of events from liquid target",5, xAxis4);
   hac_l_px__4->SetBinContent(1,0.02671228);
   hac_l_px__4->SetBinContent(2,0.04824612);
   hac_l_px__4->SetBinContent(3,0.06269968);
   hac_l_px__4->SetBinContent(4,0.06603677);
   hac_l_px__4->SetBinContent(5,0.06744232);
   hac_l_px__4->SetBinError(1,0.003465885);
   hac_l_px__4->SetBinError(2,0.004146808);
   hac_l_px__4->SetBinError(3,0.006223515);
   hac_l_px__4->SetBinError(4,0.008493869);
   hac_l_px__4->SetBinError(5,0.01393622);
   hac_l_px__4->SetEntries(219.9054);
   ...
   hac_l_px__4->GetXaxis()->SetTitle("Q^{2} ((GeV^{2})");
