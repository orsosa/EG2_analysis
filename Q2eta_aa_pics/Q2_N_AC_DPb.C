...
//=========  (Wed Jun 20 01:51:20 2018) by ROOT version 6.12/06
   ...
   gStyle->SetOptStat(0);
   c->Range(0.4833333,-13452.13,4.616667,121069.1);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetTickx(1);
   ...
   hl_ac_px__14->SetBinContent(1,89357.18);
   hl_ac_px__14->SetBinContent(2,44678.2);
   hl_ac_px__14->SetBinContent(3,20082.61);
   hl_ac_px__14->SetBinContent(4,15400.72);
   hl_ac_px__14->SetBinContent(5,9535.582);
   hl_ac_px__14->SetBinError(1,13135.21);
   hl_ac_px__14->SetBinError(2,4923.891);
   hl_ac_px__14->SetBinError(3,15818.3);
   hl_ac_px__14->SetBinError(4,3105.358);
   hl_ac_px__14->SetBinError(5,2503.426);
   hl_ac_px__14->SetEntries(69.25883);
   hl_ac_px__14->SetStats(0);
   hl_ac_px__14->SetLineWidth(3);
   hl_ac_px__14->SetMarkerStyle(8);
   hl_ac_px__14->SetMarkerSize(3);
   hl_ac_px__14->GetXaxis()->SetTitle("Q^{2} ((GeV^{2})");
