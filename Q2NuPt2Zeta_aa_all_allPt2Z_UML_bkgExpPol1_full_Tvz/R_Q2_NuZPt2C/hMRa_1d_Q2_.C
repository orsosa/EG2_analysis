...
//=========  (Mon May  7 19:51:32 2018) by ROOT version 6.12/04
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.6125,0.6340054,4.4875,1.205017);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C__1->SetBinContent(1,0.909002);
   hMR_C__1->SetBinContent(2,0.9793494);
   hMR_C__1->SetBinContent(3,0.9500238);
   hMR_C__1->SetBinContent(4,0.8737121);
   hMR_C__1->SetBinError(1,0.06940923);
   hMR_C__1->SetBinError(2,0.1086952);
   hMR_C__1->SetBinError(3,0.1761389);
   hMR_C__1->SetBinError(4,0.1618886);
   hMR_C__1->SetEntries(186.5507);
   hMR_C__1->SetStats(0);
