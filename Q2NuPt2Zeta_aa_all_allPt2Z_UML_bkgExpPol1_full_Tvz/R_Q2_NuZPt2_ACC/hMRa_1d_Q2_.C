...
//=========  (Mon May  7 19:51:38 2018) by ROOT version 6.12/04
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.6125,-0.05677846,4.4875,2.287731);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C__1->SetBinContent(1,0.9173304);
   hMR_C__1->SetBinContent(2,1.056763);
   hMR_C__1->SetBinContent(3,1.588958);
   hMR_C__1->SetBinContent(4,0.3627679);
   hMR_C__1->SetBinError(1,0.1167734);
   hMR_C__1->SetBinError(2,0.1604334);
   hMR_C__1->SetBinError(3,0.3750076);
   hMR_C__1->SetBinError(4,0.1000338);
   hMR_C__1->SetEntries(81.11081);
   hMR_C__1->SetStats(0);
