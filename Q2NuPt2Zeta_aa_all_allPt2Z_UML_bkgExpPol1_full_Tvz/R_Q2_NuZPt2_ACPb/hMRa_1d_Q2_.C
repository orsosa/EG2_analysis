...
//=========  (Mon May  7 19:51:40 2018) by ROOT version 6.12/04
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.6125,-0.1761226,4.4875,1.585103);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Pb__1->SetBinContent(1,0.4710308);
   hMR_Pb__1->SetBinContent(2,0.586137);
   hMR_Pb__1->SetBinContent(3,0.672466);
   hMR_Pb__1->SetBinContent(4,0.1521477);
   hMR_Pb__1->SetBinError(1,0.1966787);
   hMR_Pb__1->SetBinError(2,0.08921093);
   hMR_Pb__1->SetBinError(3,0.6694205);
   hMR_Pb__1->SetBinError(4,0.0836963);
   hMR_Pb__1->SetEntries(7.057222);
