...
//=========  (Mon May  7 19:51:33 2018) by ROOT version 6.12/04
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.6125,0.07225812,4.4875,1.284938);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Fe__1->SetBinContent(1,0.548293);
   hMR_Fe__1->SetBinContent(2,0.4975271);
   hMR_Fe__1->SetBinContent(3,0.6157992);
   hMR_Fe__1->SetBinContent(4,0.677498);
   hMR_Fe__1->SetBinError(1,0.02548492);
   hMR_Fe__1->SetBinError(2,0.1360792);
   hMR_Fe__1->SetBinError(3,0.2299476);
   hMR_Fe__1->SetBinError(4,0.4399744);
   hMR_Fe__1->SetEntries(20.59882);
