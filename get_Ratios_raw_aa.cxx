...
int get_Ratios_raw_aa(){
  TCanvas *c = new TCanvas();
  TFile fout("ratios_eta_aa.root","recreate");
  ...
  Float_t bins_z[5]={0.5,.6,.7,.8,1.0};
  ...
  TCut kin_lim="1.0<Q2&&Q2<4.1&&2.2<Nu&&Nu<4.25&&0.5<Z&&Z<1.0&&0.<Pt2&&Pt2<1.5";
  //  TCut meta_cut="0.45<M&&M<0.7";
  TCut meta_cut="0.45<M";
  ...
  for (int k=0;k<NT;k++)
  {
    ...
    hzl->Draw("p");
    hzs->Draw("samep");
    c->SaveAs("pic_aa_newcut/hNh_Z"+ST[k]+".gif");
    c->SaveAs("pic_aa_newcut/hNh_Z"+ST[k]+".C");
    ...
    hpt2l->Draw("p");
    hpt2s->Draw("samep");
    c->SaveAs("pic_aa_newcut/hNh_Pt2"+ST[k]+".gif");
    c->SaveAs("pic_aa_newcut/hNh_Pt2"+ST[k]+".C");
    ...
    hq2l->Draw("p");
    hq2s->Draw("samep");
    c->SaveAs("pic_aa_newcut/hNh_Q2"+ST[k]+".gif");
    c->SaveAs("pic_aa_newcut/hNh_Q2"+ST[k]+".C");
    ...
    hnul->Draw("p");
    hnus->Draw("samep");
    c->SaveAs("pic_aa_newcut/hNh_Nu"+ST[k]+".gif");
    c->SaveAs("pic_aa_newcut/hNh_Nu"+ST[k]+".C");
    ...
    {
      hsz->Draw("nostack");
      c->SaveAs("pic_aa_newcut/R_Z_aa.gif");
      c->SaveAs("pic_aa_newcut/R_Z_aa.C");
      
      hspt2->Draw("nostack");
      c->SaveAs("pic_aa_newcut/R_Pt2_aa.gif");
      c->SaveAs("pic_aa_newcut/R_Pt2_aa.C");
      
      hsq2->Draw("nostack");
      c->SaveAs("pic_aa_newcut/R_Q2_aa.gif");
      c->SaveAs("pic_aa_newcut/R_Q2_aa.C");
      
      hsnu->Draw("nostack");
      c->SaveAs("pic_aa_newcut/R_Nu_aa.gif");
      c->SaveAs("pic_aa_newcut/R_Nu_aa.C");
