...
//=========  (Mon Jun 11 20:50:23 2018) by ROOT version 6.12/06
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(-0.1875,0.2879467,1.6875,1.280738);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Fe__1->SetBinContent(1,0.5208018);
   hMR_Fe__1->SetBinContent(2,0.4609676);
   hMR_Fe__1->SetBinContent(3,0.5300088);
   hMR_Fe__1->SetBinContent(4,0.776545);
   hMR_Fe__1->SetBinContent(5,0.9501987);
   hMR_Fe__1->SetBinError(1,0.03537887);
   hMR_Fe__1->SetBinError(2,0.03772213);
   hMR_Fe__1->SetBinError(3,0.05853638);
   hMR_Fe__1->SetBinError(4,0.1240762);
   hMR_Fe__1->SetBinError(5,0.1934394);
   hMR_Fe__1->SetEntries(178.0201);
