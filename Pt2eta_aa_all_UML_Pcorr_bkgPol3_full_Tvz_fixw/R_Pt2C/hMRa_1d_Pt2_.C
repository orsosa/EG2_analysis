...
//=========  (Mon Jun 11 20:50:22 2018) by ROOT version 6.12/06
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(-0.1875,0.1627246,1.6875,2.817429);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C__1->SetBinContent(1,0.5961047);
   hMR_C__1->SetBinContent(2,0.9834361);
   hMR_C__1->SetBinContent(3,0.7521768);
   hMR_C__1->SetBinContent(4,0.8056307);
   hMR_C__1->SetBinContent(5,1.808731);
   hMR_C__1->SetBinError(1,0.07159379);
   hMR_C__1->SetBinError(2,0.1136724);
   hMR_C__1->SetBinError(3,0.1208543);
   hMR_C__1->SetBinError(4,0.1680656);
   hMR_C__1->SetBinError(5,0.6420963);
   hMR_C__1->SetEntries(51.69991);
   hMR_C__1->SetStats(0);
