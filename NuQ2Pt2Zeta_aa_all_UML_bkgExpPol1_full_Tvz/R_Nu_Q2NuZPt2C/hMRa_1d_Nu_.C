...
//=========  (Fri Apr 27 00:54:15 2018) by ROOT version 6.12/04
   ...
   c->Range(1.9375,-0.2859575,4.5625,1.712522);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C__1->SetBinContent(1,0.4353554);
   hMR_C__1->SetBinContent(2,0.7525651);
   hMR_C__1->SetBinContent(3,0.6126784);
   hMR_C__1->SetBinContent(4,1.122295);
   hMR_C__1->SetBinContent(5,0.7914411);
   hMR_C__1->SetBinContent(6,0.9934655);
   hMR_C__1->SetBinError(1,0.4489577);
   hMR_C__1->SetBinError(2,0.2123617);
   hMR_C__1->SetBinError(3,0.123907);
   hMR_C__1->SetBinError(4,0.3142469);
   hMR_C__1->SetBinError(5,0.1358957);
   hMR_C__1->SetBinError(6,0.07265366);
   hMR_C__1->SetEntries(57.64047);
   hMR_C__1->SetStats(0);
