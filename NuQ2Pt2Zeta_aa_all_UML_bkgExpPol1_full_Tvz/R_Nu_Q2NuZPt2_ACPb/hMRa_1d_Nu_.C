...
//=========  (Fri Apr 27 00:54:21 2018) by ROOT version 6.12/04
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(1.9375,-0.29404,4.5625,1.02307);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Pb__1->SetBinContent(1,0.3881799);
   hMR_Pb__1->SetBinContent(2,0.2834851);
   hMR_Pb__1->SetBinContent(3,0.4317305);
   hMR_Pb__1->SetBinContent(4,0.4727202);
   hMR_Pb__1->SetBinContent(5,0.4141104);
   hMR_Pb__1->SetBinContent(6,0.4657547);
   hMR_Pb__1->SetBinError(1,0.2117967);
   hMR_Pb__1->SetBinError(2,0.3980278);
   hMR_Pb__1->SetBinError(3,0.4094525);
   hMR_Pb__1->SetBinError(4,0.2192453);
   hMR_Pb__1->SetBinError(5,0.08010987);
   hMR_Pb__1->SetBinError(6,0.1344617);
   hMR_Pb__1->SetEntries(13.6005);
