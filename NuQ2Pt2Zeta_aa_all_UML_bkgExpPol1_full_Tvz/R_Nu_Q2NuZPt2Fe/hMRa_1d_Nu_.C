...
//=========  (Fri Apr 27 00:54:15 2018) by ROOT version 6.12/04
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(1.9375,0.1077695,4.5625,1.147651);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Fe__1->SetBinContent(1,0.2870319);
   hMR_Fe__1->SetBinContent(2,0.584413);
   hMR_Fe__1->SetBinContent(3,0.8468649);
   hMR_Fe__1->SetBinContent(4,0.7372212);
   hMR_Fe__1->SetBinContent(5,0.470686);
   hMR_Fe__1->SetBinContent(6,0.4353317);
   hMR_Fe__1->SetBinError(1,0.03754608);
   hMR_Fe__1->SetBinError(2,0.08301701);
   hMR_Fe__1->SetBinError(3,0.1571838);
   hMR_Fe__1->SetBinError(4,0.08092485);
   hMR_Fe__1->SetBinError(5,0.1799845);
   hMR_Fe__1->SetBinError(6,0.02410296);
   hMR_Fe__1->SetEntries(155.7924);
