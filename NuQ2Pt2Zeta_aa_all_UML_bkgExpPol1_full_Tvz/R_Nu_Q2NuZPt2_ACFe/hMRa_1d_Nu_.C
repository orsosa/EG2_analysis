...
//=========  (Fri Apr 27 00:54:20 2018) by ROOT version 6.12/04
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(1.9375,-0.4662738,4.5625,2.132851);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Fe__1->SetBinContent(1,0.3870533);
   hMR_Fe__1->SetBinContent(2,0.356388);
   hMR_Fe__1->SetBinContent(3,0.9173405);
   hMR_Fe__1->SetBinContent(4,1.083139);
   hMR_Fe__1->SetBinContent(5,0.4688055);
   hMR_Fe__1->SetBinContent(6,0.4422703);
   hMR_Fe__1->SetBinError(1,0.1140741);
   hMR_Fe__1->SetBinError(2,0.46845);
   hMR_Fe__1->SetBinError(3,0.8565836);
   hMR_Fe__1->SetBinError(4,0.4781416);
   hMR_Fe__1->SetBinError(5,0.1870714);
   hMR_Fe__1->SetBinError(6,0.1272504);
   hMR_Fe__1->SetEntries(10.7215);
