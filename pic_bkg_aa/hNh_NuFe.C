...
//=========  (Wed Jun 20 19:55:57 2018) by ROOT version 6.12/06
   ...
   c1->Range(1.858333,-0.000542749,4.591667,0.004884741);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetTickx(1);
   ...
   hnul__15->SetBinContent(1,0.001479339);
   hnul__15->SetBinContent(2,0.003128549);
   hnul__15->SetBinContent(3,0.004022113);
   hnul__15->SetBinContent(4,0.004117884);
   hnul__15->SetBinContent(5,0.002909886);
   hnul__15->SetBinError(1,7.561631e-06);
   hnul__15->SetBinError(2,1.324781e-05);
   hnul__15->SetBinError(3,1.531026e-05);
   hnul__15->SetBinError(4,1.734645e-05);
   hnul__15->SetBinError(5,1.249191e-05);
   hnul__15->SetEntries(265321.1);
   ...
   ptstats_LaTex = ptstats->AddText("Entries = 265321 ");
   ptstats_LaTex = ptstats->AddText("Mean  =  3.454");
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.4508");
   ...
   hnus__16->SetBinContent(1,0.0007783079);
   hnus__16->SetBinContent(2,0.001682685);
   hnus__16->SetBinContent(3,0.00220714);
   hnus__16->SetBinContent(4,0.002287264);
   hnus__16->SetBinContent(5,0.001599935);
   hnus__16->SetBinError(1,5.806444e-06);
   hnus__16->SetBinError(2,1.010707e-05);
   hnus__16->SetBinError(3,1.174254e-05);
   hnus__16->SetBinError(4,1.325261e-05);
   hnus__16->SetBinError(5,9.367329e-06);
   hnus__16->SetEntries(136267.2);
