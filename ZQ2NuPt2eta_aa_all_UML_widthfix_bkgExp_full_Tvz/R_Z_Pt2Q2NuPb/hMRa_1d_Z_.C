...
//=========  (Tue Apr 17 17:00:10 2018) by ROOT version 6.12/04
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.325,0.3283246,1.075,0.5811846);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Pb__1->SetBinContent(1,0.4497981);
   hMR_Pb__1->SetBinContent(2,0.5133425);
   hMR_Pb__1->SetBinContent(3,0.486666);
   hMR_Pb__1->SetBinContent(4,0.4859967);
   hMR_Pb__1->SetBinContent(5,0.4702024);
   hMR_Pb__1->SetBinContent(6,0.413463);
   hMR_Pb__1->SetBinError(1,0.022718);
   hMR_Pb__1->SetBinError(2,0.03292337);
   hMR_Pb__1->SetBinError(3,0.04217043);
   hMR_Pb__1->SetBinError(4,0.04262974);
   hMR_Pb__1->SetBinError(5,0.04294749);
   hMR_Pb__1->SetBinError(6,0.05067837);
   hMR_Pb__1->SetEntries(827.3321);
