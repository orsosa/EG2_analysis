...
//=========  (Tue Apr 17 17:00:09 2018) by ROOT version 6.12/04
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.325,0.4609098,1.075,0.7091134);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Fe__1->SetBinContent(1,0.655795);
   hMR_Fe__1->SetBinContent(2,0.5979144);
   hMR_Fe__1->SetBinContent(3,0.5834376);
   hMR_Fe__1->SetBinContent(4,0.525942);
   hMR_Fe__1->SetBinContent(5,0.5545589);
   hMR_Fe__1->SetBinContent(6,0.6204426);
   hMR_Fe__1->SetBinError(1,0.01904259);
   hMR_Fe__1->SetBinError(2,0.026599);
   hMR_Fe__1->SetBinError(3,0.03338309);
   hMR_Fe__1->SetBinError(4,0.03120679);
   hMR_Fe__1->SetBinError(5,0.03143514);
   hMR_Fe__1->SetBinError(6,0.05114455);
   hMR_Fe__1->SetEntries(1851.143);
