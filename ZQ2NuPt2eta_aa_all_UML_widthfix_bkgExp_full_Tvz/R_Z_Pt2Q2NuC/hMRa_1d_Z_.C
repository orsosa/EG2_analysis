...
//=========  (Tue Apr 17 17:00:08 2018) by ROOT version 6.12/04
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.325,0.6743434,1.075,1.103676);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C__1->SetBinContent(1,0.8289572);
   hMR_C__1->SetBinContent(2,0.8342423);
   hMR_C__1->SetBinContent(3,0.9723022);
   hMR_C__1->SetBinContent(4,0.9330369);
   hMR_C__1->SetBinContent(5,0.7969249);
   hMR_C__1->SetBinContent(6,0.8376792);
   hMR_C__1->SetBinError(1,0.03426765);
   hMR_C__1->SetBinError(2,0.04924797);
   hMR_C__1->SetBinError(3,0.07208463);
   hMR_C__1->SetBinError(4,0.07381945);
   hMR_C__1->SetBinError(5,0.06407161);
   hMR_C__1->SetBinError(6,0.08630479);
   hMR_C__1->SetEntries(1049.377);
   hMR_C__1->SetStats(0);
