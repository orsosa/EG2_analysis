...
//=========  (Fri Mar 16 10:45:38 2018) by ROOT version5.34/34
   ...
   hMRatio->SetBinError(4,0.01546026);
   hMRatio->SetBinError(7,0.0204137);
   hMRatio->SetBinError(10,0.02909596);
   hMRatio->SetBinError(13,0.03103223);
   hMRatio->SetBinError(16,0.02849111);
   hMRatio->SetBinError(19,0.03660539);
