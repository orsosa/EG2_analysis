...
//=========  (Fri Mar 16 10:45:38 2018) by ROOT version5.34/34
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.325,0.6866161,1.075,1.082986);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C->SetBinContent(1,0.8256822);
   hMR_C->SetBinContent(2,0.8309463);
   hMR_C->SetBinContent(3,0.9684607);
   hMR_C->SetBinContent(4,0.9293506);
   hMR_C->SetBinContent(5,0.7937765);
   hMR_C->SetBinContent(6,0.8343696);
   hMR_C->SetBinError(1,0.02842265);
   hMR_C->SetBinError(2,0.04084754);
   hMR_C->SetBinError(3,0.05978873);
   hMR_C->SetBinError(4,0.06122761);
   hMR_C->SetBinError(5,0.05314252);
   hMR_C->SetBinError(6,0.07158315);
   hMR_C->SetEntries(6);
   hMR_C->SetStats(0);
