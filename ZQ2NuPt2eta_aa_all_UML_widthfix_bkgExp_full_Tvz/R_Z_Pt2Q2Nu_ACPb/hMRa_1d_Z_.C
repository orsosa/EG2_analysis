...
//=========  (Tue Apr 17 16:53:59 2018) by ROOT version 6.12/04
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.325,0.2572294,1.075,0.641921);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Pb__1->SetBinContent(1,0.4897132);
   hMR_Pb__1->SetBinContent(2,0.4965954);
   hMR_Pb__1->SetBinContent(3,0.4701691);
   hMR_Pb__1->SetBinContent(4,0.5323929);
   hMR_Pb__1->SetBinContent(5,0.518184);
   hMR_Pb__1->SetBinContent(6,0.3643064);
   hMR_Pb__1->SetBinError(1,0.04706794);
   hMR_Pb__1->SetBinError(2,0.05614657);
   hMR_Pb__1->SetBinError(3,0.05445264);
   hMR_Pb__1->SetBinError(4,0.05640409);
   hMR_Pb__1->SetBinError(5,0.05858817);
   hMR_Pb__1->SetBinError(6,0.05465074);
   hMR_Pb__1->SetEntries(459.7352);
