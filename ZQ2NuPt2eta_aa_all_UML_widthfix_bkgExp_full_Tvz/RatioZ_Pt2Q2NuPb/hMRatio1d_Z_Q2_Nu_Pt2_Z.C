...
//=========  (Fri Mar 16 10:45:40 2018) by ROOT version5.34/34
   ...
   c->Range(0.325,0.3561317,1.075,0.5386615);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Pb->SetBinContent(1,0.4377341);
   hMR_Pb->SetBinContent(2,0.4995742);
   hMR_Pb->SetBinContent(3,0.4736132);
   hMR_Pb->SetBinContent(4,0.4729618);
   hMR_Pb->SetBinContent(5,0.4575911);
   hMR_Pb->SetBinContent(6,0.4023736);
   hMR_Pb->SetBinError(1,0.009578187);
   hMR_Pb->SetBinError(2,0.01388085);
   hMR_Pb->SetBinError(3,0.01777947);
   hMR_Pb->SetBinError(4,0.01797312);
   hMR_Pb->SetBinError(5,0.01810709);
   hMR_Pb->SetBinError(6,0.02136648);
   hMR_Pb->SetEntries(6);
   hMR_Pb->SetStats(0);
