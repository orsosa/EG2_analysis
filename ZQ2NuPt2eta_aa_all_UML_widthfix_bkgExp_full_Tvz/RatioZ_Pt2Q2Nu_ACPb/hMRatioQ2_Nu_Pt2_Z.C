...
//=========  (Fri Mar 16 10:45:50 2018) by ROOT version5.34/34
   ...
   hMRatio->SetBinError(4,0.01842093);
   hMRatio->SetBinError(7,0.02436414);
   hMRatio->SetBinError(10,0.0250191);
   hMRatio->SetBinError(13,0.0251068);
   hMRatio->SetBinError(16,0.02705901);
   hMRatio->SetBinError(19,0.02986783);
