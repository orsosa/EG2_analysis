...
//=========  (Fri Mar 16 10:45:35 2018) by ROOT version5.34/34
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.325,0.4528933,1.075,0.6904317);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Fe->SetBinContent(1,0.6403607);
   hMR_Fe->SetBinContent(2,0.5838423);
   hMR_Fe->SetBinContent(3,0.5697063);
   hMR_Fe->SetBinContent(4,0.5135639);
   hMR_Fe->SetBinContent(5,0.5415072);
   hMR_Fe->SetBinContent(6,0.6058403);
   hMR_Fe->SetBinError(1,0.01726811);
   hMR_Fe->SetBinError(2,0.0241202);
   hMR_Fe->SetBinError(3,0.030272);
   hMR_Fe->SetBinError(4,0.02829852);
   hMR_Fe->SetBinError(5,0.02850559);
   hMR_Fe->SetBinError(6,0.04637814);
   hMR_Fe->SetEntries(6);
   hMR_Fe->SetStats(0);
