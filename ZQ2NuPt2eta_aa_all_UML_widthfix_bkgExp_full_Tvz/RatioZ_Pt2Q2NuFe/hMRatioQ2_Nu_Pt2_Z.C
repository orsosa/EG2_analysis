...
//=========  (Fri Mar 16 10:45:35 2018) by ROOT version5.34/34
   ...
   hMRatio->SetBinError(4,0.008941876);
   hMRatio->SetBinError(7,0.0112209);
   hMRatio->SetBinError(10,0.0136419);
   hMRatio->SetBinError(13,0.01344133);
   hMRatio->SetBinError(16,0.0147955);
   hMRatio->SetBinError(19,0.02155218);
