...
//=========  (Mon Jun 11 20:50:28 2018) by ROOT version 6.12/06
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(-0.1875,0.0991499,1.6875,1.268664);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Fe__1->SetBinContent(1,0.4385141);
   hMR_Fe__1->SetBinContent(2,0.4739816);
   hMR_Fe__1->SetBinContent(3,0.6944285);
   hMR_Fe__1->SetBinContent(4,0.8796864);
   hMR_Fe__1->SetBinContent(5,0.8941154);
   hMR_Fe__1->SetBinError(1,0.1799814);
   hMR_Fe__1->SetBinError(2,0.1150497);
   hMR_Fe__1->SetBinError(3,0.1317047);
   hMR_Fe__1->SetBinError(4,0.1949336);
   hMR_Fe__1->SetBinError(5,0.2130445);
   hMR_Fe__1->SetEntries(78.08882);
