...
//=========  (Wed Jun 20 01:26:18 2018) by ROOT version 6.12/06
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(1.94375,0.09909947,4.50625,1.254237);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Pb__1->SetBinContent(1,0.4538336);
   hMR_Pb__1->SetBinContent(2,0.3929588);
   hMR_Pb__1->SetBinContent(3,0.6478898);
   hMR_Pb__1->SetBinContent(4,0.8758947);
   hMR_Pb__1->SetBinContent(5,0.5371808);
   hMR_Pb__1->SetBinError(1,0.1639407);
   hMR_Pb__1->SetBinError(2,0.1364358);
   hMR_Pb__1->SetBinError(3,0.1490935);
   hMR_Pb__1->SetBinError(4,0.2188235);
   hMR_Pb__1->SetBinError(5,0.177289);
   hMR_Pb__1->SetEntries(57.50359);
