...
//=========  (Wed Jun 20 01:29:42 2018) by ROOT version 6.12/06
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(1.94375,0.3166694,4.50625,1.605422);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C__1->SetBinContent(1,0.6581216);
   hMR_C__1->SetBinContent(2,0.6245075);
   hMR_C__1->SetBinContent(3,0.6994028);
   hMR_C__1->SetBinContent(4,1.168598);
   hMR_C__1->SetBinContent(5,1.012467);
   hMR_C__1->SetBinError(1,0.1658195);
   hMR_C__1->SetBinError(2,0.1071478);
   hMR_C__1->SetBinError(3,0.1433963);
   hMR_C__1->SetBinError(4,0.2588531);
   hMR_C__1->SetBinError(5,0.210401);
   hMR_C__1->SetEntries(101.4641);
   hMR_C__1->SetStats(0);
