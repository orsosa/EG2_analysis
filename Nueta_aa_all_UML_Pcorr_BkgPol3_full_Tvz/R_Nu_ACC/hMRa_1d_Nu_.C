...
//=========  (Wed Jun 20 01:26:16 2018) by ROOT version 6.12/06
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(1.94375,0.1482125,4.50625,2.097955);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C__1->SetBinContent(1,0.677605);
   hMR_C__1->SetBinContent(2,0.5940923);
   hMR_C__1->SetBinContent(3,0.7010012);
   hMR_C__1->SetBinContent(4,1.430191);
   hMR_C__1->SetBinContent(5,1.21228);
   hMR_C__1->SetBinError(1,0.2636793);
   hMR_C__1->SetBinError(2,0.1387276);
   hMR_C__1->SetBinError(3,0.1793796);
   hMR_C__1->SetBinError(4,0.3985137);
   hMR_C__1->SetBinError(5,0.3981642);
   hMR_C__1->SetEntries(48.59668);
   hMR_C__1->SetStats(0);
