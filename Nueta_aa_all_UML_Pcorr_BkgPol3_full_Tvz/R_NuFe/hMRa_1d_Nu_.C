...
//=========  (Wed Jun 20 01:29:42 2018) by ROOT version 6.12/06
   ...
   c->Range(1.94375,0.2858874,4.50625,0.9581371);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Fe__1->SetBinContent(1,0.5564653);
   hMR_Fe__1->SetBinContent(2,0.4536431);
   hMR_Fe__1->SetBinContent(3,0.5665189);
   hMR_Fe__1->SetBinContent(4,0.7519145);
   hMR_Fe__1->SetBinContent(5,0.5121874);
   hMR_Fe__1->SetBinError(1,0.05977612);
   hMR_Fe__1->SetBinError(2,0.07614078);
   hMR_Fe__1->SetBinError(3,0.08434706);
   hMR_Fe__1->SetBinError(4,0.1133881);
   hMR_Fe__1->SetBinError(5,0.06346094);
   hMR_Fe__1->SetEntries(241.8322);
