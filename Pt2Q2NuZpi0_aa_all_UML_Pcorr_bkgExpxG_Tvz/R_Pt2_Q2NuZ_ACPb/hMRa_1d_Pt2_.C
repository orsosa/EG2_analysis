...
//=========  (Sat Jun  9 06:52:17 2018) by ROOT version 6.12/06
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(-0.1875,0.3600039,1.6875,0.778026);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Pb__1->SetBinContent(1,0.4358435);
   hMR_Pb__1->SetBinContent(2,0.4618863);
   hMR_Pb__1->SetBinContent(3,0.4884387);
   hMR_Pb__1->SetBinContent(4,0.4786112);
   hMR_Pb__1->SetBinContent(5,0.5206771);
   hMR_Pb__1->SetBinContent(6,0.6853358);
   hMR_Pb__1->SetBinError(1,0.01887102);
   hMR_Pb__1->SetBinError(2,0.016161);
   hMR_Pb__1->SetBinError(3,0.01545015);
   hMR_Pb__1->SetBinError(4,0.01954272);
   hMR_Pb__1->SetBinError(5,0.02306483);
   hMR_Pb__1->SetBinError(6,0.0349633);
   hMR_Pb__1->SetEntries(3151.305);
