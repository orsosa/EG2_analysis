{
  ...
  //  TString fname="Zeta_aa_all_UML_Pcorr_BkgPol3_full_Tvz/sim_CD_D/binned.root";
  //  TString fname="Pt2eta_aa_all_UML_Pcorr_BkgPol3_full_Tvz/sim_CD_D/binned.root";
  //  TString fname="Nueta_aa_all_UML_Pcorr_BkgPol3_full_Tvz/data_CD_C/binned.root";
  //    TString fname="Q2eta_aa_all_UML_Pcorr_BkgPol3_full_Tvz/sim_CD_D/binned.root";
  TString fname="PhiPQeta_aa_all_UML_Pcorr_BkgPol3_full_Tvz/sim_CD_D/binned.root";
  ...
  */
    ...
    *a3=0.03;
    //    s->setRange(0.01,0.06); works for every one
    //*s=0.04848;// value for solid
    *s=0.0514883;// value for liquid    
    s->setError(s->getVal()*0.1);
    //    s->setConstant();//fix
    RooRealVar *m= w->var("m");
    m->setRange(0.54,0.6);
    *m=0.56;
