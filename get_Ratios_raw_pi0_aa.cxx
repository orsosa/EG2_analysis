...
int get_Ratios_raw_pi0_aa(){
  TCanvas *c = new TCanvas();
  TFile fout("ratios_eta_pi0_aa.root","recreate");
  ...
  */
  TH1D *hzs = new TH1D("hzs","z solid data",12,0.3,1.0);
  TH1D *hpt2s = new TH1D("hpt2s","Pt^{2} solid data",12,0,1.5);
  TH1D *hnus = new TH1D("hnus","#nu solid data",12,2.2,4.25);
  TH1D *hq2s = new TH1D("hq2s","Q^{2} solid data",12,1.0,4.1);
  ...
  for (int k=0;k<NT;k++)
  {
    ...
    hzl->Draw("p");
    hzs->Draw("samep");
    c->SaveAs("pic_pi0_aa_newcut/hNh_Z"+ST[k]+".gif");
    c->SaveAs("pic_pi0_aa_newcut/hNh_Z"+ST[k]+".C");
    ...
    hpt2l->Draw("p");
    hpt2s->Draw("samep");
    c->SaveAs("pic_pi0_aa_newcut/hNh_Pt2"+ST[k]+".gif");
    c->SaveAs("pic_pi0_aa_newcut/hNh_Pt2"+ST[k]+".C");
    ...
    hq2l->Draw("p");
    hq2s->Draw("samep");
    c->SaveAs("pic_pi0_aa_newcut/hNh_Q2"+ST[k]+".gif");
    c->SaveAs("pic_pi0_aa_newcut/hNh_Q2"+ST[k]+".C");
    ...
    hnul->Draw("p");
    hnus->Draw("samep");
    c->SaveAs("pic_pi0_aa_newcut/hNh_Nu"+ST[k]+".gif");
    c->SaveAs("pic_pi0_aa_newcut/hNh_Nu"+ST[k]+".C");
    ...
    {
      hsz->Draw("nostack");
      c->SaveAs("pic_pi0_aa_newcut/R_Z_pi0_aa.gif");
      c->SaveAs("pic_pi0_aa_newcut/R_Z_pi0_aa.C");
      
      hspt2->Draw("nostack");
      c->SaveAs("pic_pi0_aa_newcut/R_Pt2_pi0_aa.gif");
      c->SaveAs("pic_pi0_aa_newcut/R_Pt2_pi0_aa.C");
      
      hsq2->Draw("nostack");
      c->SaveAs("pic_pi0_aa_newcut/R_Q2_pi0_aa.gif");
      c->SaveAs("pic_pi0_aa_newcut/R_Q2_pi0_aa.C");
      
      hsnu->Draw("nostack");
      c->SaveAs("pic_pi0_aa_newcut/R_Nu_pi0_aa.gif");
      c->SaveAs("pic_pi0_aa_newcut/R_Nu_pi0_aa.C");
