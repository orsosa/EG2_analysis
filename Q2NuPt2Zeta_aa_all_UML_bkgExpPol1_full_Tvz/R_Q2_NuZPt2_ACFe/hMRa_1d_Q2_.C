...
//=========  (Fri Apr 27 20:25:43 2018) by ROOT version 6.12/04
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.6125,0.04531922,4.4875,1.400513);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Fe__1->SetBinContent(1,0.4927666);
   hMR_Fe__1->SetBinContent(2,0.5604869);
   hMR_Fe__1->SetBinContent(3,0.8962933);
   hMR_Fe__1->SetBinContent(4,0.3219427);
   hMR_Fe__1->SetBinError(1,0.2298425);
   hMR_Fe__1->SetBinError(2,0.2734546);
   hMR_Fe__1->SetBinError(3,0.3170736);
   hMR_Fe__1->SetBinError(4,0.09193608);
   hMR_Fe__1->SetEntries(21.8082);
