...
//=========  (Fri Apr 27 20:25:48 2018) by ROOT version 6.12/04
   ...
   c->Range(0.6125,-0.2632353,4.4875,1.147962);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Pb__1->SetBinContent(1,0.514088);
   hMR_Pb__1->SetBinContent(2,0.4742414);
   hMR_Pb__1->SetBinContent(3,0.4150605);
   hMR_Pb__1->SetBinContent(4,0.4410834);
   hMR_Pb__1->SetBinError(1,0.1087057);
   hMR_Pb__1->SetBinError(2,0.1188328);
   hMR_Pb__1->SetBinError(3,0.4088218);
   hMR_Pb__1->SetBinError(4,0.511999);
   hMR_Pb__1->SetEntries(7.473548);
