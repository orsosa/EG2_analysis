...
//=========  (Fri Apr 27 20:25:43 2018) by ROOT version 6.12/04
   ...
   c->Range(0.6125,-0.2787625,4.4875,2.582655);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C__1->SetBinContent(1,0.8371401);
   hMR_C__1->SetBinContent(2,1.068853);
   hMR_C__1->SetBinContent(3,1.397292);
   hMR_C__1->SetBinContent(4,0.3848403);
   hMR_C__1->SetBinError(1,0.3942686);
   hMR_C__1->SetBinError(2,0.5262426);
   hMR_C__1->SetBinError(3,0.7902146);
   hMR_C__1->SetBinError(4,0.2736455);
   hMR_C__1->SetEntries(12.01933);
   hMR_C__1->SetStats(0);
