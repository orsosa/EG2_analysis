...
//=========  (Fri Feb 16 10:53:44 2018) by ROOT version5.34/34
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.325,0.3627132,1.075,0.5562167);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Pb->SetBinContent(1,0.4501619);
   hMR_Pb->SetBinContent(2,0.513692);
   hMR_Pb->SetBinContent(3,0.4694329);
   hMR_Pb->SetBinContent(4,0.4756314);
   hMR_Pb->SetBinContent(5,0.4350431);
   hMR_Pb->SetBinContent(6,0.4119048);
   hMR_Pb->SetBinError(1,0.01137596);
   hMR_Pb->SetBinError(2,0.01580279);
   hMR_Pb->SetBinError(3,0.01905885);
   hMR_Pb->SetBinError(4,0.01868844);
   hMR_Pb->SetBinError(5,0.01811583);
   hMR_Pb->SetBinError(6,0.02282073);
   hMR_Pb->SetEntries(6);
   hMR_Pb->SetStats(0);
