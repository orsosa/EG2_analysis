...
//=========  (Fri Mar 16 04:36:37 2018) by ROOT version5.34/34
   ...
   hMRatio->SetBinError(4,0.01687629);
   hMRatio->SetBinError(7,0.02142185);
   hMRatio->SetBinError(10,0.0298262);
   hMRatio->SetBinError(13,0.03135845);
   hMRatio->SetBinError(16,0.02815181);
   hMRatio->SetBinError(19,0.0355618);
