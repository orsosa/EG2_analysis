...
//=========  (Fri Feb 16 10:50:28 2018) by ROOT version5.34/34
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.325,0.3976103,1.075,1.076685);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   TH1F *hMR_Pb = new TH1F("hMR_Pb","hMR_Pb",6, xAxis2);
   hMR_Pb->SetBinContent(1,0.7017927);
   hMR_Pb->SetBinContent(2,0.9820273);
   hMR_Pb->SetBinContent(3,0.6731657);
   hMR_Pb->SetBinContent(4,0.7448519);
   hMR_Pb->SetBinContent(5,0.695083);
   hMR_Pb->SetBinContent(6,0.490926);
   hMR_Pb->SetBinError(1,0.0007029531);
   hMR_Pb->SetBinError(2,0.000880952);
   hMR_Pb->SetBinError(3,0.0009463658);
   hMR_Pb->SetBinError(4,0.001139509);
   hMR_Pb->SetBinError(5,0.0009647466);
   hMR_Pb->SetBinError(6,0.0007705151);
   hMR_Pb->SetEntries(6);
   hMR_Pb->SetStats(0);
