...
//=========  (Fri Mar 16 04:37:10 2018) by ROOT version5.34/34
   ...
   hMRatio->SetBinError(4,0.03955112);
   hMRatio->SetBinError(7,0.04158361);
   hMRatio->SetBinError(10,0.03669628);
   hMRatio->SetBinError(13,0.03201268);
   hMRatio->SetBinError(16,0.03969274);
   hMRatio->SetBinError(19,0.0522281);
