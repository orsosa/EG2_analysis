...
//=========  (Fri Mar 16 04:37:10 2018) by ROOT version5.34/34
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.325,0.5817856,1.075,1.223845);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Fe->SetBinContent(1,1.023745);
   hMR_Fe->SetBinContent(2,1.133507);
   hMR_Fe->SetBinContent(3,0.8113459);
   hMR_Fe->SetBinContent(4,0.7862204);
   hMR_Fe->SetBinContent(5,0.875049);
   hMR_Fe->SetBinContent(6,0.6709473);
   hMR_Fe->SetBinError(1,0.001466881);
   hMR_Fe->SetBinError(2,0.001672789);
   hMR_Fe->SetBinError(3,0.001657047);
   hMR_Fe->SetBinError(4,0.001908367);
   hMR_Fe->SetBinError(5,0.001819321);
   hMR_Fe->SetBinError(6,0.001661057);
   hMR_Fe->SetEntries(6);
   hMR_Fe->SetStats(0);
