...
//=========  (Fri Mar 16 04:37:20 2018) by ROOT version5.34/34
   ...
   c->Range(0.325,0.8104576,1.075,1.7191);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C->SetBinContent(1,1.313485);
   hMR_C->SetBinContent(2,1.59056);
   hMR_C->SetBinContent(3,1.397461);
   hMR_C->SetBinContent(4,1.452992);
   hMR_C->SetBinContent(5,1.234888);
   hMR_C->SetBinContent(6,0.9370066);
   hMR_C->SetBinError(1,0.002432503);
   hMR_C->SetBinError(2,0.003060635);
   hMR_C->SetBinError(3,0.00372571);
   hMR_C->SetBinError(4,0.004677149);
   hMR_C->SetBinError(5,0.003399485);
   hMR_C->SetBinError(6,0.002718164);
   hMR_C->SetEntries(6);
   hMR_C->SetStats(0);
