...
//=========  (Fri Mar 16 04:37:26 2018) by ROOT version5.34/34
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.325,0.389359,1.075,1.054399);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Pb->SetBinContent(1,0.6872588);
   hMR_Pb->SetBinContent(2,0.9616899);
   hMR_Pb->SetBinContent(3,0.6592247);
   hMR_Pb->SetBinContent(4,0.7294264);
   hMR_Pb->SetBinContent(5,0.6806881);
   hMR_Pb->SetBinContent(6,0.4807591);
   hMR_Pb->SetBinError(1,0.0006963636);
   hMR_Pb->SetBinError(2,0.0008706442);
   hMR_Pb->SetBinError(3,0.0009418728);
   hMR_Pb->SetBinError(4,0.001134943);
   hMR_Pb->SetBinError(5,0.0009600472);
   hMR_Pb->SetBinError(6,0.0007675815);
   hMR_Pb->SetEntries(6);
   hMR_Pb->SetStats(0);
