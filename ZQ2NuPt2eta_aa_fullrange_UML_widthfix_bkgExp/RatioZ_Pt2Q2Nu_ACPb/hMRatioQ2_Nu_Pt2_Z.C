...
//=========  (Fri Mar 16 04:37:26 2018) by ROOT version5.34/34
   ...
   hMRatio->SetBinError(4,0.02794126);
   hMRatio->SetBinError(7,0.03708507);
   hMRatio->SetBinError(10,0.03274626);
   hMRatio->SetBinError(13,0.03286267);
   hMRatio->SetBinError(16,0.0342005);
   hMRatio->SetBinError(19,0.04085755);
