...
//=========  (Fri Feb 16 10:53:42 2018) by ROOT version5.34/34
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.325,0.64246,1.075,1.098649);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C->SetBinContent(1,0.8378474);
   hMR_C->SetBinContent(2,0.8273878);
   hMR_C->SetBinContent(3,0.9691054);
   hMR_C->SetBinContent(4,0.9226638);
   hMR_C->SetBinContent(5,0.7686043);
   hMR_C->SetBinContent(6,0.7818137);
   hMR_C->SetBinError(1,0.03478984);
   hMR_C->SetBinError(2,0.04761075);
   hMR_C->SetBinError(3,0.06654577);
   hMR_C->SetBinError(4,0.06684358);
   hMR_C->SetBinError(5,0.05683512);
   hMR_C->SetBinError(6,0.07718372);
   hMR_C->SetEntries(6);
   hMR_C->SetStats(0);
