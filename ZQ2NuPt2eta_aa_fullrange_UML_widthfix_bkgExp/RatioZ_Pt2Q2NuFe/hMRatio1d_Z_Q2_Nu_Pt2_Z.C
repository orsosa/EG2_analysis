...
//=========  (Fri Feb 16 10:50:23 2018) by ROOT version5.34/34
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.325,0.5910684,1.075,1.243304);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   TH1F *hMR_Fe = new TH1F("hMR_Fe","hMR_Fe",6, xAxis2);
   hMR_Fe->SetBinContent(1,1.040035);
   hMR_Fe->SetBinContent(2,1.151543);
   hMR_Fe->SetBinContent(3,0.8242561);
   hMR_Fe->SetBinContent(4,0.7987307);
   hMR_Fe->SetBinContent(5,0.8889728);
   hMR_Fe->SetBinContent(6,0.6816233);
   hMR_Fe->SetBinError(1,0.001483561);
   hMR_Fe->SetBinError(2,0.001690727);
   hMR_Fe->SetBinError(3,0.001666348);
   hMR_Fe->SetBinError(4,0.001915957);
   hMR_Fe->SetBinError(5,0.001829176);
   hMR_Fe->SetBinError(6,0.001667408);
   hMR_Fe->SetEntries(6);
   hMR_Fe->SetStats(0);
