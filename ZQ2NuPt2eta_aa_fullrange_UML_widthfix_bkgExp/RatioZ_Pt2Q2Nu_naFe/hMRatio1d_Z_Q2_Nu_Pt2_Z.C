...
//=========  (Fri Feb 16 10:53:39 2018) by ROOT version5.34/34
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.325,0.4414919,1.075,0.7277782);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Fe->SetBinContent(1,0.6671259);
   hMR_Fe->SetBinContent(2,0.6023644);
   hMR_Fe->SetBinContent(3,0.574796);
   hMR_Fe->SetBinContent(4,0.5100362);
   hMR_Fe->SetBinContent(5,0.5563959);
   hMR_Fe->SetBinContent(6,0.5719067);
   hMR_Fe->SetBinError(1,0.02111752);
   hMR_Fe->SetBinError(2,0.02674526);
   hMR_Fe->SetBinError(3,0.03118857);
   hMR_Fe->SetBinError(4,0.02952882);
   hMR_Fe->SetBinError(5,0.03098205);
   hMR_Fe->SetBinError(6,0.04752119);
   hMR_Fe->SetEntries(6);
   hMR_Fe->SetStats(0);
