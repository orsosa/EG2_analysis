...
//=========  (Wed Jan 31 01:09:41 2018) by ROOT version5.34/34
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.325,0.421933,1.075,0.9144786);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Fe->SetBinContent(1,0.6745132);
   hMR_Fe->SetBinContent(2,0.6116874);
   hMR_Fe->SetBinContent(3,0.5423358);
   hMR_Fe->SetBinContent(4,0.6256082);
   hMR_Fe->SetBinContent(5,0.6223122);
   hMR_Fe->SetBinContent(6,0.7603477);
   hMR_Fe->SetBinError(1,0.03243139);
   hMR_Fe->SetBinError(2,0.04766271);
   hMR_Fe->SetBinError(3,0.05327808);
   hMR_Fe->SetBinError(4,0.05138516);
   hMR_Fe->SetBinError(5,0.04713552);
   hMR_Fe->SetBinError(6,0.08611266);
   hMR_Fe->SetEntries(6);
   hMR_Fe->SetStats(0);
