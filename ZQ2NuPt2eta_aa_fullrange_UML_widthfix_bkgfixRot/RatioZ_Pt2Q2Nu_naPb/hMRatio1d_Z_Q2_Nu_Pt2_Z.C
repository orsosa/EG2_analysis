...
//=========  (Wed Jan 31 01:09:46 2018) by ROOT version5.34/34
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.325,0.2492581,1.075,0.7331248);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Pb->SetBinContent(1,0.4210234);
   hMR_Pb->SetBinContent(2,0.4750215);
   hMR_Pb->SetBinContent(3,0.5274967);
   hMR_Pb->SetBinContent(4,0.5281485);
   hMR_Pb->SetBinContent(5,0.6203494);
   hMR_Pb->SetBinContent(6,0.3610289);
   hMR_Pb->SetBinError(1,0.01428755);
   hMR_Pb->SetBinError(2,0.02349123);
   hMR_Pb->SetBinError(3,0.04889658);
   hMR_Pb->SetBinError(4,0.04582128);
   hMR_Pb->SetBinError(5,0.0459557);
   hMR_Pb->SetBinError(6,0.04582881);
   hMR_Pb->SetEntries(6);
   hMR_Pb->SetStats(0);
