...
//=========  (Wed Jun 20 01:49:48 2018) by ROOT version 6.12/06
   ...
   gStyle->SetOptStat(0);
   c->Range(1.858333,-2301.923,4.591667,20717.31);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetTickx(1);
   ...
   c->SetFrameBorderMode(0);
   Double_t xAxis13[6] = {2.2, 2.86, 3.22, 3.58, 3.87, 4.25}; 
   
   TH1D *hs_ac_px__13 = new TH1D("hs_ac_px__13","N hadrons + AC C",5, xAxis13);
   hs_ac_px__13->SetBinContent(1,13900.65);
   hs_ac_px__13->SetBinContent(2,7691.768);
   hs_ac_px__13->SetBinContent(3,9785.873);
   hs_ac_px__13->SetBinContent(4,6245.475);
   hs_ac_px__13->SetBinContent(5,6619.599);
   hs_ac_px__13->SetBinError(1,3637.812);
   hs_ac_px__13->SetBinError(2,2482.733);
   hs_ac_px__13->SetBinError(3,1663.372);
   hs_ac_px__13->SetBinError(4,1023.664);
   hs_ac_px__13->SetBinError(5,1778.165);
   hs_ac_px__13->SetEntries(74.2193);
   hs_ac_px__13->SetStats(0);
   hs_ac_px__13->SetLineWidth(3);
   hs_ac_px__13->SetMarkerStyle(8);
   hs_ac_px__13->SetMarkerSize(3);
   hs_ac_px__13->GetXaxis()->SetTitle("#nu ((GeV)");
