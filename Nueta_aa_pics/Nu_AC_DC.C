...
//=========  (Wed Jun 20 01:49:48 2018) by ROOT version 6.12/06
   ...
   c->SetFrameBorderMode(0);
   Double_t xAxis4[6] = {2.2, 2.86, 3.22, 3.58, 3.87, 4.25}; 
   
   TH1D *hac_l_px__4 = new TH1D("hac_l_px__4","Acceptance of events from liquid target",5, xAxis4);
   hac_l_px__4->SetBinContent(1,0.0175006);
   hac_l_px__4->SetBinContent(2,0.03846506);
   hac_l_px__4->SetBinContent(3,0.04796089);
   hac_l_px__4->SetBinContent(4,0.08770251);
   hac_l_px__4->SetBinContent(5,0.05491186);
   hac_l_px__4->SetBinError(1,0.004099165);
   hac_l_px__4->SetBinError(2,0.004014117);
   hac_l_px__4->SetBinError(3,0.004959096);
   hac_l_px__4->SetBinError(4,0.01083472);
   hac_l_px__4->SetBinError(5,0.009209809);
   hac_l_px__4->SetEntries(234.03);
   ...
   hac_l_px__4->GetXaxis()->SetTitle("#nu ((GeV)");
