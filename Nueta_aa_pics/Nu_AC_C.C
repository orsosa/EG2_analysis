...
//=========  (Wed Jun 20 01:49:48 2018) by ROOT version 6.12/06
   ...
   hac_s_px__3->SetBinContent(1,0.0169974);
   hac_s_px__3->SetBinContent(2,0.04043432);
   hac_s_px__3->SetBinContent(3,0.04785154);
   hac_s_px__3->SetBinContent(4,0.07166103);
   hac_s_px__3->SetBinContent(5,0.04586106);
   hac_s_px__3->SetBinError(1,0.003091401);
   hac_s_px__3->SetBinError(2,0.004818388);
   hac_s_px__3->SetBinError(3,0.005403774);
   hac_s_px__3->SetBinError(4,0.008268945);
   hac_s_px__3->SetBinError(5,0.008768875);
   hac_s_px__3->SetEntries(239.5363);
   ...
   hac_s_px__3->GetXaxis()->SetTitle("#nu ((GeV)");
