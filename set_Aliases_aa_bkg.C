{
  ...
  outbkgnd->SetAlias("Eeta","fE[0]+fE[1]");
  outbkgnd->SetAlias("Pxeta","fX[0]+fX[1]");
  outbkgnd->SetAlias("Pyeta","fY[0]+fY[1]");
  outbkgnd->SetAlias("Pzeta","fZ[0]+fZ[1]");
  ...
  outbkgnd->SetAlias("meta0","TMath::Sqrt( 2*p0p1 )");

  outbkgnd->SetAlias("ct","(fX[0]*fX[1] + fY[0]*fY[1] + fZ[0]*fZ[1])/(fE[0]*fE[1])");
  outbkgnd->SetAlias("metaT","TMath::Sqrt( 2*fE[0]*fE[1]*(1-ct) )");
  outbkgnd->SetAlias("metaT2","2*fE[0]*fE[1]*(1-ct)");
  ...
  outbkgnd->SetAlias("bDotr_a0","bX*fX[0] + bY*fY[0] + bZ*fZ[0]");
  outbkgnd->SetAlias("bDotr_a1","bX*fX[1] + bY*fY[1] + bZ*fZ[1]");

  outbkgnd->SetAlias("Ea0_b","g*(fE[0] - bDotr_a0)");
  outbkgnd->SetAlias("Ea1_b","g*(fE[1] - bDotr_a1)");

  outbkgnd->SetAlias("Pxa0_b","fX[0]+(g-1)/(b*b)*(bDotr_a0)*bX - g*fE[0]*bX");
  outbkgnd->SetAlias("Pya0_b","fY[0]+(g-1)/(b*b)*(bDotr_a0)*bY - g*fE[0]*bY");
  outbkgnd->SetAlias("Pza0_b","fZ[0]+(g-1)/(b*b)*(bDotr_a0)*bZ - g*fE[0]*bZ");

  outbkgnd->SetAlias("Pxa1_b","fX[1]+(g-1)/(b*b)*(bDotr_a1)*bX - g*fE[1]*bX");
  outbkgnd->SetAlias("Pya1_b","fY[1]+(g-1)/(b*b)*(bDotr_a1)*bY - g*fE[1]*bY");
  outbkgnd->SetAlias("Pza1_b","fZ[1]+(g-1)/(b*b)*(bDotr_a1)*bZ - g*fE[1]*bZ");

  outbkgnd->SetAlias("ma0","TMath::Sqrt(fE[0]*fE[0] - fX[0]*fX[0] - fY[0]*fY[0] - fZ[0]*fZ[0])");
  outbkgnd->SetAlias("ma1","TMath::Sqrt(fE[1]*fE[1] - fX[1]*fX[1] - fY[1]*fY[1] - fZ[1]*fZ[1])");

  outbkgnd->SetAlias("ma0_2","fE[0]*fE[0] - fX[0]*fX[0] - fY[0]*fY[0] - fZ[0]*fZ[0]");
  outbkgnd->SetAlias("ma1_2","fE[1]*fE[1] - fX[1]*fX[1] - fY[1]*fY[1] - fZ[1]*fZ[1]");
  ...
  outbkgnd->SetAlias("Dm","meta-ma0-ma1");
  outbkgnd->SetAlias("Dm0","meta0-ma0-ma1");

  outbkgnd->SetAlias("minAngle","2*TMath::ATan(0.500/(TMath::Sqrt(Eeta*Eeta-0.540*0.500)))*TMath::RadToDeg()");
  ...
  /*
  outbkgnd->Draw("meta>>hm",!pi0cut0,"");
  outbkgnd->Draw("meta0>>hm0",!pi0cut,"same");
  outbkgnd->Draw("Dm>>hdm",!pi0cut,"same");
  outbkgnd->Draw("Dm0>>hdm0",pi0cut,"same");
  */
 ...
 //outbkgnd->Draw("meta>>h0n",pi0cut&&planecut,"same");
  ...
  /*
  Int_t nev=outbkgnd->Draw("meta",ma0cut&&ma1cut&&"0.4<Z&&Z<0.5");
  Double_t *dataArr=outbkgnd->GetV1();
  ...
  */
  ...
  /*
  outbkgnd->Draw("meta>>hm",ma0cut&&ma1cut);
  outbkgnd->Draw("metaT>>hmT",ma0cut&&ma1cut);
