...
int get_Ratios_raw(){
  ...
  TFile fout("ratios_eta_3pi.root","recreate");
  ...
  /*
  Float_t bins_z[5]={0.5,0.6,0.7,0.8,1.0};

  TH1D *hzs = new TH1D("hzs","z solid data",4,bins_z);

  Float_t bins_pt2[5]={0, 0.18, 0.36, 0.54, 1.5};
  TH1D *hpt2s = new TH1D("hpt2s","Pt^{2} solid data",4,bins_pt2);

  Float_t bins_nu[6]={2.2, 2.86, 3.22, 3.58, 3.87, 4.25};
  TH1D *hnus = new TH1D("hnus","#un solid data",5,bins_nu);

  Float_t bins_q2[6]={1.0, 1.33, 1.66, 2.0, 2.5, 4.1};
  TH1D *hq2s = new TH1D("hq2s","Q^{2} solid data",5,bins_q2);
  */
  
  TH1D *hzs = new TH1D("hzs","z solid data",6,0.5,1.0);
  TH1D *hpt2s = new TH1D("hpt2s","Pt^{2} solid data",6,0,1.0);
  TH1D *hnus = new TH1D("hnus","#un solid data",6,2.2,4.25);
  TH1D *hq2s = new TH1D("hq2s","Q^{2} solid data",6,1.0,4.1);
  ...
  TCut kin_lim=pi0cut&&"1.0<Q2&&Q2<4.1&&2.2<Nu&&Nu<4.25&&0.5<Z&&Z<1.0&&0.<Pt2&&Pt2<1.5";
  TCut meta_cut="M<0.65";
  ...
  {
    hsz->Print();
    TFile fin("eta_"+ST[k]+"D_3pi.root");
    ...
    hzl->Draw("p");
    hzs->Draw("samep");
    c->SaveAs("pic_3pi_newcut/hNh_Z"+ST[k]+".gif");
    c->SaveAs("pic_3pi_newcut/hNh_Z"+ST[k]+".C");
    ...
    hpt2l->Draw("p");
    hpt2s->Draw("samep");
    c->SaveAs("pic_3pi_newcut/hNh_Pt2"+ST[k]+".gif");
    c->SaveAs("pic_3pi_newcut/hNh_Pt2"+ST[k]+".C");
    ...
    hq2l->Draw("p");
    hq2s->Draw("samep");
    c->SaveAs("pic_3pi_newcut/hNh_Q2"+ST[k]+".gif");
    c->SaveAs("pic_3pi_newcut/hNh_Q2"+ST[k]+".C");
    ...
    hnul->Draw("p");
    hnus->Draw("samep");
    c->SaveAs("pic_3pi_newcut/hNh_Nu"+ST[k]+".gif");
    c->SaveAs("pic_3pi_newcut/hNh_Nu"+ST[k]+".C");
    ...
    {
      hsz->Draw("nostack");
      c->SaveAs("pic_3pi_newcut/R_Z_3pi.gif");
      c->SaveAs("pic_3pi_newcut/R_Z_3pi.C");
      
      hspt2->Draw("nostack");
      c->SaveAs("pic_3pi_newcut/R_Pt2_3pi.gif");
      c->SaveAs("pic_3pi_newcut/R_Pt2_3pi.C");
      
      hsq2->Draw("nostack");
      c->SaveAs("pic_3pi_newcut/R_Q2_3pi.gif");
      c->SaveAs("pic_3pi_newcut/R_Q2_3pi.C");
      
      hsnu->Draw("nostack");
      c->SaveAs("pic_3pi_newcut/R_Nu_3pi.gif");
      c->SaveAs("pic_3pi_newcut/R_Nu_3pi.C");
