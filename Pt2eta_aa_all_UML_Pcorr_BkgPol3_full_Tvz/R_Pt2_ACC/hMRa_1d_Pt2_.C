...
//=========  (Sun Jun 17 20:49:19 2018) by ROOT version 6.12/06
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(-0.1875,-0.1522337,1.6875,4.295284);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C__1->SetBinContent(1,0.6649258);
   hMR_C__1->SetBinContent(2,0.8908681);
   hMR_C__1->SetBinContent(3,0.954195);
   hMR_C__1->SetBinContent(4,0.6676561);
   hMR_C__1->SetBinContent(5,2.590895);
   hMR_C__1->SetBinError(1,0.2110466);
   hMR_C__1->SetBinError(2,0.23649);
   hMR_C__1->SetBinError(3,0.2565304);
   hMR_C__1->SetBinError(4,0.1730276);
   hMR_C__1->SetBinError(5,1.090208);
   hMR_C__1->SetEntries(24.03006);
   hMR_C__1->SetStats(0);
