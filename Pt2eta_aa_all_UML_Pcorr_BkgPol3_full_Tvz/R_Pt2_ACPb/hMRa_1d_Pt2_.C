...
//=========  (Sun Jun 17 20:49:21 2018) by ROOT version 6.12/06
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(-0.1875,0.1170987,1.6875,1.754323);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Pb__1->SetBinContent(1,0.5296269);
   hMR_Pb__1->SetBinContent(2,0.4635011);
   hMR_Pb__1->SetBinContent(3,0.5156085);
   hMR_Pb__1->SetBinContent(4,0.5637938);
   hMR_Pb__1->SetBinContent(5,1.110875);
   hMR_Pb__1->SetBinError(1,0.1722601);
   hMR_Pb__1->SetBinError(2,0.1232795);
   hMR_Pb__1->SetBinError(3,0.1537207);
   hMR_Pb__1->SetBinError(4,0.1431485);
   hMR_Pb__1->SetBinError(5,0.4173555);
   hMR_Pb__1->SetEntries(38.50644);
