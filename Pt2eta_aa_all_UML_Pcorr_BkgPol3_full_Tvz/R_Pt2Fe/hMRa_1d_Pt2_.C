...
//=========  (Sun Jun 17 20:49:16 2018) by ROOT version 6.12/06
   ...
   c->Range(-0.1875,0.07321383,1.6875,1.428236);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Fe__1->SetBinContent(1,0.553708);
   hMR_Fe__1->SetBinContent(2,0.463199);
   hMR_Fe__1->SetBinContent(3,0.4909942);
   hMR_Fe__1->SetBinContent(4,0.8092738);
   hMR_Fe__1->SetBinContent(5,0.9921056);
   hMR_Fe__1->SetBinError(1,0.05215962);
   hMR_Fe__1->SetBinError(2,0.2053211);
   hMR_Fe__1->SetBinError(3,0.0765999);
   hMR_Fe__1->SetBinError(4,0.1924854);
   hMR_Fe__1->SetBinError(5,0.2490083);
   hMR_Fe__1->SetEntries(73.10605);
