...
//=========  (Sun Jun 17 20:49:15 2018) by ROOT version 6.12/06
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(-0.1875,-0.09982762,1.6875,4.449483);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C__1->SetBinContent(1,0.6158984);
   hMR_C__1->SetBinContent(2,0.938625);
   hMR_C__1->SetBinContent(3,0.792375);
   hMR_C__1->SetBinContent(4,0.6611049);
   hMR_C__1->SetBinContent(5,2.725542);
   hMR_C__1->SetBinError(1,0.08052646);
   hMR_C__1->SetBinError(2,0.1514909);
   hMR_C__1->SetBinError(3,0.1742656);
   hMR_C__1->SetBinError(4,0.140947);
   hMR_C__1->SetBinError(5,1.095703);
   hMR_C__1->SetEntries(25.67775);
   hMR_C__1->SetStats(0);
