...
//=========  (Sun Jun 17 21:53:22 2018) by ROOT version 6.12/06
   ...
   c->Range(1.94375,0.2437219,4.50625,1.365145);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C__1->SetBinContent(1,0.5301115);
   hMR_C__1->SetBinContent(2,0.5219609);
   hMR_C__1->SetBinContent(3,0.5870197);
   hMR_C__1->SetBinContent(4,0.9908146);
   hMR_C__1->SetBinContent(5,0.8583625);
   hMR_C__1->SetBinError(1,0.1335607);
   hMR_C__1->SetBinError(2,0.08954926);
   hMR_C__1->SetBinError(3,0.1203517);
   hMR_C__1->SetBinError(4,0.2194675);
   hMR_C__1->SetBinError(5,0.1783717);
   hMR_C__1->SetEntries(101.1267);
   hMR_C__1->SetStats(0);
