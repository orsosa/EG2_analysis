...
//=========  (Sun Jun 17 21:53:18 2018) by ROOT version 6.12/06
   ...
   c->Range(1.94375,0.1570475,4.50625,1.196748);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Fe__1->SetBinContent(1,0.4941229);
   hMR_Fe__1->SetBinContent(2,0.3883666);
   hMR_Fe__1->SetBinContent(3,0.5176585);
   hMR_Fe__1->SetBinContent(4,0.8586596);
   hMR_Fe__1->SetBinContent(5,0.5892933);
   hMR_Fe__1->SetBinError(1,0.155846);
   hMR_Fe__1->SetBinError(2,0.08962746);
   hMR_Fe__1->SetBinError(3,0.110553);
   hMR_Fe__1->SetBinError(4,0.1945109);
   hMR_Fe__1->SetBinError(5,0.1667179);
   hMR_Fe__1->SetEntries(73.62717);
