...
//=========  (Wed Jun 20 22:57:10 2018) by ROOT version 6.12/06
   ...
   c1->Range(0.4833333,-77.94606,4.616667,701.5145);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetTickx(1);
   ...
   TH1D *hq2l__5 = new TH1D("hq2l__5","Q^{2} solid data",6,1,4.1);
   hq2l__5->SetBinContent(1,570);
   hq2l__5->SetBinContent(2,386);
   hq2l__5->SetBinContent(3,146);
   hq2l__5->SetBinContent(4,53);
   hq2l__5->SetBinContent(5,19);
   hq2l__5->SetBinContent(6,6);
   hq2l__5->SetBinError(1,23.87467);
   hq2l__5->SetBinError(2,19.64688);
   hq2l__5->SetBinError(3,12.08305);
   hq2l__5->SetBinError(4,7.28011);
   hq2l__5->SetBinError(5,4.358899);
   hq2l__5->SetBinError(6,2.44949);
   hq2l__5->SetEntries(1180);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  =  1.657");
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.5027");
   ...
   TH1D *hq2s__6 = new TH1D("hq2s__6","Q^{2} solid data",6,1,4.1);
   hq2s__6->SetBinContent(1,369);
   hq2s__6->SetBinContent(2,228);
   hq2s__6->SetBinContent(3,99);
   hq2s__6->SetBinContent(4,38);
   hq2s__6->SetBinContent(5,10);
   hq2s__6->SetBinContent(6,1);
   hq2s__6->SetBinError(1,19.20937);
   hq2s__6->SetBinError(2,15.09967);
   hq2s__6->SetBinError(3,9.949874);
   hq2s__6->SetBinError(4,6.164414);
   hq2s__6->SetBinError(5,3.162278);
   hq2s__6->SetBinError(6,1);
   hq2s__6->SetEntries(745);
