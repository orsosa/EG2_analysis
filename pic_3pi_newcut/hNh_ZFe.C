...
//=========  (Wed Jun 20 22:57:32 2018) by ROOT version 6.12/06
   ...
   c1->Range(0.4166667,-126.4653,1.083333,1138.188);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetTickx(1);
   ...
   TH1D *hzl__9 = new TH1D("hzl__9","z solid data",6,0.5,1);
   hzl__9->SetBinContent(1,933);
   hzl__9->SetBinContent(2,547);
   hzl__9->SetBinContent(3,310);
   hzl__9->SetBinContent(4,164);
   hzl__9->SetBinContent(5,70);
   hzl__9->SetBinContent(6,23);
   hzl__9->SetBinError(1,30.54505);
   hzl__9->SetBinError(2,23.38803);
   hzl__9->SetBinError(3,17.60682);
   hzl__9->SetBinError(4,12.80625);
   hzl__9->SetBinError(5,8.3666);
   hzl__9->SetBinError(6,4.795832);
   hzl__9->SetEntries(2047);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = 0.6212");
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.1016");
   ...
   TH1D *hzs__10 = new TH1D("hzs__10","z solid data",6,0.5,1);
   hzs__10->SetBinContent(1,470);
   hzs__10->SetBinContent(2,222);
   hzs__10->SetBinContent(3,115);
   hzs__10->SetBinContent(4,56);
   hzs__10->SetBinContent(5,33);
   hzs__10->SetBinContent(6,8);
   hzs__10->SetBinError(1,21.67948);
   hzs__10->SetBinError(2,14.89966);
   hzs__10->SetBinError(3,10.72381);
   hzs__10->SetBinError(4,7.483315);
   hzs__10->SetBinError(5,5.744563);
   hzs__10->SetBinError(6,2.828427);
   hzs__10->SetEntries(904);
