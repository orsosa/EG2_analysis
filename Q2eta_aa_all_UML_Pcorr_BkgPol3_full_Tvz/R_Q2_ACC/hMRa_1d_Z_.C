...
//=========  (Wed Jun 20 01:18:38 2018) by ROOT version 6.12/06
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.4375,0.6793704,1.0625,1.011147);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   TH1D *hMR_C__1 = new TH1D("hMR_C__1","hMR_C",1, xAxis1);
   hMR_C__1->SetBinContent(1,0.8449576);
   hMR_C__1->SetBinError(1,0.1203723);
   hMR_C__1->SetEntries(49.27386);
   hMR_C__1->SetStats(0);
