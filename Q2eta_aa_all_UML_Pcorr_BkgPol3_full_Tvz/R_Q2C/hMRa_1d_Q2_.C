...
//=========  (Wed Jun 20 01:35:10 2018) by ROOT version 6.12/06
   ...
   c->Range(0.6125,0.3652659,4.4875,1.407302);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C__1->SetBinContent(1,0.5934793);
   hMR_C__1->SetBinContent(2,1.052103);
   hMR_C__1->SetBinContent(3,0.8953405);
   hMR_C__1->SetBinContent(4,0.7388578);
   hMR_C__1->SetBinContent(5,0.9189631);
   hMR_C__1->SetBinError(1,0.08620339);
   hMR_C__1->SetBinError(2,0.2112989);
   hMR_C__1->SetBinError(3,0.1978353);
   hMR_C__1->SetBinError(4,0.1764159);
   hMR_C__1->SetBinError(5,0.2347175);
   hMR_C__1->SetEntries(99.35894);
   hMR_C__1->SetStats(0);
