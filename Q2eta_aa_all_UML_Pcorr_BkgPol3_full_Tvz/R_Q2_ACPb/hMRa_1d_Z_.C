...
//=========  (Wed Jun 20 01:18:40 2018) by ROOT version 6.12/06
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.4375,0.4568643,1.0625,0.7293238);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   TH1D *hMR_Pb__1 = new TH1D("hMR_Pb__1","hMR_Pb",1, xAxis1);
   hMR_Pb__1->SetBinContent(1,0.5928469);
   hMR_Pb__1->SetBinError(1,0.09885154);
   hMR_Pb__1->SetEntries(35.96817);
