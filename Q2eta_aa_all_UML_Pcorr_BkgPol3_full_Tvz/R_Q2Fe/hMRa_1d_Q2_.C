...
//=========  (Wed Jun 20 01:35:10 2018) by ROOT version 6.12/06
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.6125,-0.07674862,4.4875,1.162927);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Fe__1->SetBinContent(1,0.6362141);
   hMR_Fe__1->SetBinContent(2,0.367901);
   hMR_Fe__1->SetBinContent(3,0.5345075);
   hMR_Fe__1->SetBinContent(4,0.7857419);
   hMR_Fe__1->SetBinContent(5,0.5419649);
   hMR_Fe__1->SetBinError(1,0.0772753);
   hMR_Fe__1->SetBinError(2,0.04102722);
   hMR_Fe__1->SetBinError(3,0.09760184);
   hMR_Fe__1->SetBinError(4,0.1299348);
   hMR_Fe__1->SetBinError(5,0.449769);
   hMR_Fe__1->SetEntries(34.76046);
