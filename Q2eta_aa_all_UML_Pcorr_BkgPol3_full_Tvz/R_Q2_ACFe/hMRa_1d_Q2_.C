...
//=========  (Wed Jun 20 01:20:26 2018) by ROOT version 6.12/06
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.6125,-0.2304549,4.4875,2.074094);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Fe__1->SetBinContent(1,0.7691244);
   hMR_Fe__1->SetBinContent(2,0.3534251);
   hMR_Fe__1->SetBinContent(3,0.5789598);
   hMR_Fe__1->SetBinContent(4,0.7596121);
   hMR_Fe__1->SetBinContent(5,0.8908314);
   hMR_Fe__1->SetBinError(1,0.1604966);
   hMR_Fe__1->SetBinError(2,0.07661107);
   hMR_Fe__1->SetBinError(3,0.1396332);
   hMR_Fe__1->SetBinError(4,0.2491618);
   hMR_Fe__1->SetBinError(5,0.8650151);
   hMR_Fe__1->SetEntries(13.04252);
