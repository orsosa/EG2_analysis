...
//=========  (Mon Jun 18 02:32:37 2018) by ROOT version 6.12/06
   ...
   cn->Range(-0.25,-0.155607,1.75,0.1179188);
   cn->SetFillColor(0);
   cn->SetBorderMode(0);
   cn->SetBorderSize(2);
   cn->SetGridx();
   ...
   hC_Taya__4->SetBinContent(1,-0.118308);
   hC_Taya__4->SetBinContent(2,0.01431178);
   hC_Taya__4->SetBinContent(3,0.05369727);
   hC_Taya__4->SetBinContent(4,0.01157162);
   hC_Taya__4->SetBinContent(5,-0.06397616);
   hC_Taya__4->SetBinContent(6,-0.04963066);
   hC_Taya__4->SetBinError(1,0.02905108);
   hC_Taya__4->SetBinError(2,0.02873299);
   hC_Taya__4->SetBinError(3,0.02370806);
   hC_Taya__4->SetBinError(4,0.02995125);
   hC_Taya__4->SetBinError(5,0.02885537);
   hC_Taya__4->SetBinError(6,0.04223083);
   hC_Taya__4->SetMinimum(-0.1282544);
   hC_Taya__4->SetMaximum(0.09056621);
   hC_Taya__4->SetEntries(4896.258);
   ...
   hC_Taya__4->GetXaxis()->SetTitle("Pt2");
   ...
   hC_Taya__4->GetYaxis()->SetTitle("R(Pt2)");
   ...
   hFe_Taya__5->SetBinContent(1,-0.01184423);
   hFe_Taya__5->SetBinContent(2,-0.007625418);
   hFe_Taya__5->SetBinContent(3,0.02979043);
   hFe_Taya__5->SetBinContent(4,0.06184782);
   hFe_Taya__5->SetBinContent(5,-0.02770084);
   hFe_Taya__5->SetBinContent(6,-0.06134107);
   hFe_Taya__5->SetBinError(1,0.02071055);
   hFe_Taya__5->SetBinError(2,0.01948274);
   hFe_Taya__5->SetBinError(3,0.04081367);
   hFe_Taya__5->SetBinError(4,0.02128402);
   hFe_Taya__5->SetBinError(5,0.01867557);
   hFe_Taya__5->SetBinError(6,0.04320792);
   hFe_Taya__5->SetEntries(3477.453);
   ...
   hFe_Taya__5->GetXaxis()->SetTitle("Pt2");
   ...
   hFe_Taya__5->GetYaxis()->SetTitle("R(Pt2)");
   ...
   hPb_Taya__6->SetBinContent(1,0.0049665);
   hPb_Taya__6->SetBinContent(2,0.0236503);
   hPb_Taya__6->SetBinContent(3,0.02505275);
   hPb_Taya__6->SetBinContent(4,-0.002993746);
   hPb_Taya__6->SetBinContent(5,-0.02424085);
   hPb_Taya__6->SetBinContent(6,0.08061982);
   hPb_Taya__6->SetBinError(1,0.01887102);
   hPb_Taya__6->SetBinError(2,0.016161);
   hPb_Taya__6->SetBinError(3,0.01545015);
   hPb_Taya__6->SetBinError(4,0.01954272);
   hPb_Taya__6->SetBinError(5,0.02306483);
   hPb_Taya__6->SetBinError(6,0.0349633);
   hPb_Taya__6->SetEntries(3157.305);
   hPb_Taya__6->SetStats(0);
   hPb_Taya__6->SetLineWidth(3);
   hPb_Taya__6->SetMarkerStyle(8);
   hPb_Taya__6->SetMarkerSize(3);
   hPb_Taya__6->GetXaxis()->SetTitle("Pt2");
   ...
   hPb_Taya__6->GetYaxis()->SetTitle("R(Pt2)");
