...
//=========  (Tue Jun 19 00:54:26 2018) by ROOT version 6.12/06
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.4375,-1.022489,1.0625,3.384155);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C__1->SetBinContent(1,0.740751);
   hMR_C__1->SetBinContent(2,1.700662);
   hMR_C__1->SetBinContent(3,0.7673832);
   hMR_C__1->SetBinContent(4,0.9298229);
   hMR_C__1->SetBinContent(5,1.176836);
   hMR_C__1->SetBinError(1,0.4501457);
   hMR_C__1->SetBinError(2,0.9841624);
   hMR_C__1->SetBinError(3,1.149605);
   hMR_C__1->SetBinError(4,0.9555459);
   hMR_C__1->SetBinError(5,1.598782);
   hMR_C__1->SetEntries(4.739048);
   hMR_C__1->SetStats(0);
