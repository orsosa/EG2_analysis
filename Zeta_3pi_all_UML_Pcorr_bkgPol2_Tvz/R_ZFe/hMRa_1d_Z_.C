...
//=========  (Tue Jun 19 00:54:27 2018) by ROOT version 6.12/06
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.4375,-0.144502,1.0625,1.300518);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Fe__1->SetBinContent(1,0.6239834);
   hMR_Fe__1->SetBinContent(2,0.3946419);
   hMR_Fe__1->SetBinContent(3,0.5515786);
   hMR_Fe__1->SetBinContent(4,0.5690978);
   hMR_Fe__1->SetBinContent(5,0.7141237);
   hMR_Fe__1->SetBinError(1,0.2393288);
   hMR_Fe__1->SetBinError(2,0.2070256);
   hMR_Fe__1->SetBinError(3,0.1794277);
   hMR_Fe__1->SetBinError(4,0.53187);
   hMR_Fe__1->SetBinError(5,0.2479786);
   hMR_Fe__1->SetEntries(17.0796);
