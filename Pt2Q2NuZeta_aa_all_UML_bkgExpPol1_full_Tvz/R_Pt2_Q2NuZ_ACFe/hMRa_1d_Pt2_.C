...
//=========  (Fri Apr 27 20:21:21 2018) by ROOT version 6.12/04
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(-0.1875,-0.1074367,1.6875,1.627537);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Fe__1->SetBinContent(1,0.1865659);
   hMR_Fe__1->SetBinContent(2,0.647932);
   hMR_Fe__1->SetBinContent(3,0.7411217);
   hMR_Fe__1->SetBinContent(4,1.216714);
   hMR_Fe__1->SetBinError(1,0.05755827);
   hMR_Fe__1->SetBinError(2,0.2254303);
   hMR_Fe__1->SetBinError(3,0.1249573);
   hMR_Fe__1->SetBinError(4,0.1712319);
   hMR_Fe__1->SetEntries(78.706);
