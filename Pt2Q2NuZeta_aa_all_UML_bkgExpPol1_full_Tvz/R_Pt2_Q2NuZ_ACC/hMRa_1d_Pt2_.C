...
//=========  (Fri Apr 27 20:21:21 2018) by ROOT version 6.12/04
   ...
   c->Range(-0.1875,-0.1421744,1.6875,2.020858);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C__1->SetBinContent(1,0.2762835);
   hMR_C__1->SetBinContent(2,0.8270171);
   hMR_C__1->SetBinContent(3,1.130442);
   hMR_C__1->SetBinContent(4,1.422919);
   hMR_C__1->SetBinError(1,0.1236773);
   hMR_C__1->SetBinError(2,0.3535023);
   hMR_C__1->SetBinError(3,0.2019315);
   hMR_C__1->SetBinError(4,0.2992349);
   hMR_C__1->SetEntries(49.4171);
   hMR_C__1->SetStats(0);
