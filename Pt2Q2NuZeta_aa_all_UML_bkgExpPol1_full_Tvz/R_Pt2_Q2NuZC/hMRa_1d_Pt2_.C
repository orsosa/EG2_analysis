...
//=========  (Fri Apr 27 20:21:15 2018) by ROOT version 6.12/04
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(-0.1875,0.3264847,1.6875,1.579303);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C__1->SetBinContent(1,0.8010523);
   hMR_C__1->SetBinContent(2,0.9390991);
   hMR_C__1->SetBinContent(3,1.081375);
   hMR_C__1->SetBinContent(4,1.170569);
   hMR_C__1->SetBinError(1,0.3038321);
   hMR_C__1->SetBinError(2,0.3789223);
   hMR_C__1->SetBinError(3,0.1360681);
   hMR_C__1->SetBinError(4,0.2357256);
   hMR_C__1->SetEntries(51.41291);
   hMR_C__1->SetStats(0);
