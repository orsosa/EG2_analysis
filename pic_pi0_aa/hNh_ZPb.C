...
//=========  (Wed Jun 20 07:11:01 2018) by ROOT version 6.12/06
   ...
   c1->Range(0.1833333,-39181,1.116667,352629);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetTickx(1);
   ...
   hzl__17->SetBinContent(1,297976);
   hzl__17->SetBinContent(2,160951);
   hzl__17->SetBinContent(3,87221);
   hzl__17->SetBinContent(4,48931);
   hzl__17->SetBinContent(5,28939);
   hzl__17->SetBinContent(6,30690);
   hzl__17->SetBinError(1,545.8718);
   hzl__17->SetBinError(2,401.187);
   hzl__17->SetBinError(3,295.332);
   hzl__17->SetBinError(4,221.2035);
   hzl__17->SetBinError(5,170.1147);
   hzl__17->SetBinError(6,175.1856);
   hzl__17->SetEntries(654708);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = 0.4617");
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.1504");
   ...
   hzs__18->SetBinContent(1,60617);
   hzs__18->SetBinContent(2,31779);
   hzs__18->SetBinContent(3,17099);
   hzs__18->SetBinContent(4,9628);
   hzs__18->SetBinContent(5,5476);
   hzs__18->SetBinContent(6,5170);
   hzs__18->SetBinError(1,246.2052);
   hzs__18->SetBinError(2,178.2667);
   hzs__18->SetBinError(3,130.7631);
   hzs__18->SetBinError(4,98.12237);
   hzs__18->SetBinError(5,74);
   hzs__18->SetBinError(6,71.90271);
   hzs__18->SetEntries(129769);
