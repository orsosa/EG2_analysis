...
//=========  (Wed Jun 20 07:10:16 2018) by ROOT version 6.12/06
   ...
   c1->Range(1.858333,-0.001423003,4.591667,0.01280703);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetTickx(1);
   ...
   hnul__15->SetBinContent(1,0.004845639);
   hnul__15->SetBinContent(2,0.009199851);
   hnul__15->SetBinContent(3,0.01081564);
   hnul__15->SetBinContent(4,0.01030098);
   hnul__15->SetBinContent(5,0.00674752);
   hnul__15->SetBinError(1,1.487641e-05);
   hnul__15->SetBinError(2,2.408452e-05);
   hnul__15->SetBinError(3,2.628557e-05);
   hnul__15->SetBinError(4,2.848187e-05);
   hnul__15->SetBinError(5,1.964478e-05);
   hnul__15->SetEntries(653080);
   ...
   ptstats_LaTex = ptstats->AddText("Entries = 653080 ");
   ptstats_LaTex = ptstats->AddText("Mean  =  3.407");
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.4605");
   ...
   hnus__16->SetBinContent(1,0.00292514);
   hnus__16->SetBinContent(2,0.005499886);
   hnus__16->SetBinContent(3,0.006715466);
   hnus__16->SetBinContent(4,0.006418626);
   hnus__16->SetBinContent(5,0.004332718);
   hnus__16->SetBinError(1,1.19785e-05);
   hnus__16->SetBinError(2,1.905954e-05);
   hnus__16->SetBinError(3,2.120229e-05);
   hnus__16->SetBinError(4,2.285161e-05);
   hnus__16->SetBinError(5,1.585296e-05);
   hnus__16->SetEntries(387551.8);
