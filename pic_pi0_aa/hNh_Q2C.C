...
//=========  (Wed Jun 20 07:08:52 2018) by ROOT version 6.12/06
   ...
   c1->Range(0.4833333,-0.001744338,4.616667,0.01569904);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetTickx(1);
   ...
   hq2l__5->SetBinContent(1,0.005391431);
   hq2l__5->SetBinContent(2,0.009698537);
   hq2l__5->SetBinContent(3,0.01193406);
   hq2l__5->SetBinContent(4,0.01323612);
   hq2l__5->SetBinContent(5,0.01177761);
   hq2l__5->SetBinError(1,1.513061e-05);
   hq2l__5->SetBinError(2,2.885982e-05);
   hq2l__5->SetBinError(3,4.320898e-05);
   hq2l__5->SetBinError(4,5.407208e-05);
   hq2l__5->SetBinError(5,6.327214e-05);
   hq2l__5->SetEntries(274749.4);
   ...
   ptstats_LaTex = ptstats->AddText("Entries = 274749 ");
   ptstats_LaTex = ptstats->AddText("Mean  =  2.138");
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.7111");
   ...
   hq2s__6->SetBinContent(1,0.004491618);
   hq2s__6->SetBinContent(2,0.008069204);
   hq2s__6->SetBinContent(3,0.009951472);
   hq2s__6->SetBinContent(4,0.01121789);
   hq2s__6->SetBinContent(5,0.01027669);
   hq2s__6->SetBinError(1,1.50615e-05);
   hq2s__6->SetBinError(2,2.851192e-05);
   hq2s__6->SetBinError(3,4.282669e-05);
   hq2s__6->SetBinError(4,5.398688e-05);
   hq2s__6->SetBinError(5,6.440289e-05);
   hq2s__6->SetEntries(194903.6);
