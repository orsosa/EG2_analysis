...
//=========  (Wed Jun 20 07:10:16 2018) by ROOT version 6.12/06
   ...
   c1->Range(-0.25,-36258.75,1.75,326328.7);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetTickx(1);
   ...
   hpt2l__11->SetBinContent(1,236509);
   hpt2l__11->SetBinContent(2,275732);
   hpt2l__11->SetBinContent(3,152125);
   hpt2l__11->SetBinContent(4,69260);
   hpt2l__11->SetBinContent(5,36648);
   hpt2l__11->SetBinContent(6,19118);
   hpt2l__11->SetBinError(1,486.3219);
   hpt2l__11->SetBinError(2,525.1019);
   hpt2l__11->SetBinError(3,390.032);
   hpt2l__11->SetBinError(4,263.1729);
   hpt2l__11->SetBinError(5,191.4367);
   hpt2l__11->SetBinError(6,138.2679);
   hpt2l__11->SetEntries(789392);
   ...
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.1975");
   ...
   hpt2s__12->SetBinContent(1,122070);
   hpt2s__12->SetBinContent(2,149232);
   hpt2s__12->SetBinContent(3,87334);
   hpt2s__12->SetBinContent(4,43615);
   hpt2s__12->SetBinContent(5,25524);
   hpt2s__12->SetBinContent(6,16997);
   hpt2s__12->SetBinError(1,349.3852);
   hpt2s__12->SetBinError(2,386.3056);
   hpt2s__12->SetBinError(3,295.5233);
   hpt2s__12->SetBinError(4,208.842);
   hpt2s__12->SetBinError(5,159.7623);
   hpt2s__12->SetBinError(6,130.3725);
   hpt2s__12->SetEntries(444772);
