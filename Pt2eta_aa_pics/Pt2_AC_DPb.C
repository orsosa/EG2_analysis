...
//=========  (Sun Jun 17 20:56:22 2018) by ROOT version 6.12/06
   ...
   c->SetFrameBorderMode(0);
   Double_t xAxis16[6] = {0, 0.18, 0.36, 0.54, 0.72, 1.5}; 
   
   TH1D *hac_l_px__16 = new TH1D("hac_l_px__16","Acceptance of events from liquid target",5, xAxis16);
   hac_l_px__16->SetBinContent(1,0.0321391);
   hac_l_px__16->SetBinContent(2,0.03923677);
   hac_l_px__16->SetBinContent(3,0.05182585);
   hac_l_px__16->SetBinContent(4,0.04551052);
   hac_l_px__16->SetBinContent(5,0.05246517);
   hac_l_px__16->SetBinError(1,0.004964271);
   hac_l_px__16->SetBinError(2,0.004504674);
   hac_l_px__16->SetBinError(3,0.00643851);
   hac_l_px__16->SetBinError(4,0.005540485);
   hac_l_px__16->SetBinError(5,0.00330858);
   hac_l_px__16->SetEntries(382.0812);
   ...
   hac_l_px__16->GetXaxis()->SetTitle("Pt^{2} (GeV^{2})");
