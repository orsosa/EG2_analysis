...
//=========  (Wed Jun 20 06:36:00 2018) by ROOT version 6.12/06
   ...
   TH1D *hzl__1 = new TH1D("hzl__1","z solid data",5,0.5,1);
   hzl__1->SetBinContent(1,237);
   hzl__1->SetBinContent(2,116);
   hzl__1->SetBinContent(3,70);
   hzl__1->SetBinContent(4,29);
   hzl__1->SetBinContent(5,13);
   hzl__1->SetBinError(1,15.3948);
   hzl__1->SetBinError(2,10.77033);
   hzl__1->SetBinError(3,8.3666);
   hzl__1->SetBinError(4,5.385165);
   hzl__1->SetBinError(5,3.605551);
   hzl__1->SetEntries(465);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = 0.6293");
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.1059");
   ...
   TH1D *hzs__2 = new TH1D("hzs__2","z solid data",5,0.5,1);
   hzs__2->SetBinContent(1,178);
   hzs__2->SetBinContent(2,91);
   hzs__2->SetBinContent(3,28);
   hzs__2->SetBinContent(4,23);
   hzs__2->SetBinContent(5,11);
   hzs__2->SetBinError(1,13.34166);
   hzs__2->SetBinError(2,9.539392);
   hzs__2->SetBinError(3,5.291503);
   hzs__2->SetBinError(4,4.795832);
   hzs__2->SetBinError(5,3.316625);
   hzs__2->SetEntries(331);
