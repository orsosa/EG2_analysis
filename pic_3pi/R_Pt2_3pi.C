...
//=========  (Wed Jun 20 06:41:14 2018) by ROOT version 6.12/06
   ...
   c1->Range(-0.25,-0.2016039,1.75,1.814435);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetTickx(1);
   ...
   Double_t xAxis19[6] = {0, 0.18, 0.36, 0.54, 0.72, 1.5}; 
   
   TH1F *R_pt2_stack_2 = new TH1F("R_pt2_stack_2","Multiplicity ratios pt2",5, xAxis19);
   R_pt2_stack_2->SetMinimum(0);
   R_pt2_stack_2->SetMaximum(1.612831);
   ...
   Double_t xAxis20[6] = {0, 0.18, 0.36, 0.54, 0.72, 1.5}; 
   
   TH1D *hRpt2_C_stack_1 = new TH1D("hRpt2_C_stack_1","Pt^{2} solid data",5, xAxis20);
   hRpt2_C_stack_1->SetBinContent(1,0.622071);
   hRpt2_C_stack_1->SetBinContent(2,0.7198264);
   hRpt2_C_stack_1->SetBinContent(3,1.071446);
   hRpt2_C_stack_1->SetBinContent(4,1.53603);
   hRpt2_C_stack_1->SetBinContent(5,1.291155);
   hRpt2_C_stack_1->SetBinError(1,0.08908117);
   hRpt2_C_stack_1->SetBinError(2,0.09101756);
   hRpt2_C_stack_1->SetBinError(3,0.1627212);
   hRpt2_C_stack_1->SetBinError(4,0.3418034);
   hRpt2_C_stack_1->SetBinError(5,0.3452961);
   hRpt2_C_stack_1->SetEntries(98.52008);
   ...
   Double_t xAxis21[6] = {0, 0.18, 0.36, 0.54, 0.72, 1.5}; 
   
   TH1D *hRpt2_Fe_stack_2 = new TH1D("hRpt2_Fe_stack_2","Pt^{2} solid data",5, xAxis21);
   ...
   Double_t xAxis22[6] = {0, 0.18, 0.36, 0.54, 0.72, 1.5}; 
   
   TH1D *hRpt2_Pb_stack_3 = new TH1D("hRpt2_Pb_stack_3","Pt^{2} solid data",5, xAxis22);
   hRpt2_Pb_stack_3->SetBinContent(1,0.2835593);
   hRpt2_Pb_stack_3->SetBinContent(2,0.4699527);
   hRpt2_Pb_stack_3->SetBinContent(3,0.4679032);
   hRpt2_Pb_stack_3->SetBinContent(4,0.7251421);
   hRpt2_Pb_stack_3->SetBinContent(5,0.6031626);
   hRpt2_Pb_stack_3->SetBinError(1,0.05572137);
   hRpt2_Pb_stack_3->SetBinError(2,0.0681483);
   hRpt2_Pb_stack_3->SetBinError(3,0.08655721);
   hRpt2_Pb_stack_3->SetBinError(4,0.1901485);
   hRpt2_Pb_stack_3->SetBinError(5,0.1873991);
   hRpt2_Pb_stack_3->SetEntries(75.14289);
