...
//=========  (Wed Jun 20 06:41:14 2018) by ROOT version 6.12/06
   ...
   c1->Range(0.4166667,-0.1335036,1.083333,1.201532);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetTickx(1);
   ...
   R_z_stack_1->SetMaximum(1.068029);
   ...
   TH1D *hRz_C_stack_1 = new TH1D("hRz_C_stack_1","z solid data",5,0.5,1);
   hRz_C_stack_1->SetBinContent(1,0.9028506);
   hRz_C_stack_1->SetBinContent(2,0.9430347);
   hRz_C_stack_1->SetBinContent(3,0.480844);
   hRz_C_stack_1->SetBinContent(4,0.9533977);
   hRz_C_stack_1->SetBinContent(5,1.01717);
   hRz_C_stack_1->SetBinError(1,0.08954798);
   hRz_C_stack_1->SetBinError(2,0.1320575);
   hRz_C_stack_1->SetBinError(3,0.10752);
   hRz_C_stack_1->SetBinError(4,0.2662029);
   hRz_C_stack_1->SetBinError(5,0.4167074);
   hRz_C_stack_1->SetEntries(65.59485);
   ...
   TH1D *hRz_Fe_stack_2 = new TH1D("hRz_Fe_stack_2","z solid data",5,0.5,1);
   ...
   TH1D *hRz_Pb_stack_3 = new TH1D("hRz_Pb_stack_3","z solid data",5,0.5,1);
   hRz_Pb_stack_3->SetBinContent(1,0.442566);
   hRz_Pb_stack_3->SetBinContent(2,0.4143669);
   hRz_Pb_stack_3->SetBinContent(3,0.3042325);
   hRz_Pb_stack_3->SetBinContent(4,0.9142342);
   hRz_Pb_stack_3->SetBinContent(5,0.6959568);
   hRz_Pb_stack_3->SetBinError(1,0.05567738);
   hRz_Pb_stack_3->SetBinError(2,0.07286744);
   hRz_Pb_stack_3->SetBinError(3,0.07617877);
   hRz_Pb_stack_3->SetBinError(4,0.2610788);
   hRz_Pb_stack_3->SetBinError(5,0.354066);
   hRz_Pb_stack_3->SetEntries(36.97171);
