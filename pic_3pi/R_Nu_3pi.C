...
//=========  (Wed Jun 20 06:41:14 2018) by ROOT version 6.12/06
   ...
   TH1D *hRnu_C_stack_1 = new TH1D("hRnu_C_stack_1","#un solid data",5, xAxis28);
   ...
   TH1D *hRnu_Fe_stack_2 = new TH1D("hRnu_Fe_stack_2","#un solid data",5, xAxis29);
   ...
   TH1D *hRnu_Pb_stack_3 = new TH1D("hRnu_Pb_stack_3","#un solid data",5, xAxis30);
