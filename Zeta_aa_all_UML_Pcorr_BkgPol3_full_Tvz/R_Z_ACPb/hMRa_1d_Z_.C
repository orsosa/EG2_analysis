...
//=========  (Sun Jun 17 19:27:04 2018) by ROOT version 6.12/06
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.4375,0.2099518,1.0625,1.038333);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Pb__1->SetBinContent(1,0.6912098);
   hMR_Pb__1->SetBinContent(2,0.4556429);
   hMR_Pb__1->SetBinContent(3,0.4898363);
   hMR_Pb__1->SetBinContent(4,0.5708613);
   hMR_Pb__1->SetBinContent(5,0.4940042);
   hMR_Pb__1->SetBinError(1,0.2327281);
   hMR_Pb__1->SetBinError(2,0.1327982);
   hMR_Pb__1->SetBinError(3,0.1018768);
   hMR_Pb__1->SetBinError(4,0.1390107);
   hMR_Pb__1->SetBinError(5,0.1293865);
   hMR_Pb__1->SetEntries(61.72452);
