...
//=========  (Sun Jun 17 19:27:03 2018) by ROOT version 6.12/06
   ...
   c->Range(0.4375,0.3147245,1.0625,1.918578);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C__1->SetBinContent(1,1.167631);
   hMR_C__1->SetBinContent(2,0.7898207);
   hMR_C__1->SetBinContent(3,0.6590898);
   hMR_C__1->SetBinContent(4,0.773534);
   hMR_C__1->SetBinContent(5,0.9137521);
   hMR_C__1->SetBinError(1,0.5294622);
   hMR_C__1->SetBinError(2,0.2194863);
   hMR_C__1->SetBinError(3,0.1257903);
   hMR_C__1->SetBinError(4,0.1641433);
   hMR_C__1->SetBinError(5,0.2177437);
   hMR_C__1->SetEntries(44.24095);
   hMR_C__1->SetStats(0);
