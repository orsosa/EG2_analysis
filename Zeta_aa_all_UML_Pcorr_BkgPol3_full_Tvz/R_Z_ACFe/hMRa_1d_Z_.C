...
//=========  (Sun Jun 17 19:27:03 2018) by ROOT version 6.12/06
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.4375,0.315196,1.0625,1.110394);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Fe__1->SetBinContent(1,0.636872);
   hMR_Fe__1->SetBinContent(2,0.6633856);
   hMR_Fe__1->SetBinContent(3,0.5376791);
   hMR_Fe__1->SetBinContent(4,0.5945696);
   hMR_Fe__1->SetBinContent(5,0.8318883);
   hMR_Fe__1->SetBinError(1,0.2040446);
   hMR_Fe__1->SetBinError(2,0.1856527);
   hMR_Fe__1->SetBinError(3,0.1141126);
   hMR_Fe__1->SetBinError(4,0.1007634);
   hMR_Fe__1->SetBinError(5,0.1686927);
   hMR_Fe__1->SetEntries(83.42595);
