...
//=========  (Sun Jun 17 20:05:40 2018) by ROOT version 6.12/06
   ...
   gStyle->SetOptStat(0);
   c->Range(0.4166667,-219.4532,1.083333,1975.079);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetTickx(1);
   ...
   c->SetFrameBorderMode(0);
   Double_t xAxis6[6] = {0.5, 0.6, 0.7, 0.8, 0.9, 1}; 
   
   TH1D *hl_px__6 = new TH1D("hl_px__6","N hadrons D_C",5, xAxis6);
   hl_px__6->SetBinContent(1,1419.25);
   hl_px__6->SetBinContent(2,1439.314);
   hl_px__6->SetBinContent(3,961.0385);
   hl_px__6->SetBinContent(4,784.5901);
   hl_px__6->SetBinContent(5,356.0573);
   hl_px__6->SetBinError(1,252.7749);
   hl_px__6->SetBinError(2,124.0131);
   hl_px__6->SetBinError(3,87.37843);
   hl_px__6->SetBinError(4,73.26692);
   hl_px__6->SetBinError(5,45.49611);
   hl_px__6->SetEntries(260.7818);
   hl_px__6->SetStats(0);
