...
//=========  (Sun Jun 17 20:05:40 2018) by ROOT version 6.12/06
   ...
   c->SetFrameBorderMode(0);
   Double_t xAxis9[6] = {0.5, 0.6, 0.7, 0.8, 0.9, 1}; 
   
   TH1D *hac_s_px__9 = new TH1D("hac_s_px__9","Acceptance of events from solid target",5, xAxis9);
   hac_s_px__9->SetBinContent(1,0.03534004);
   hac_s_px__9->SetBinContent(2,0.04051848);
   hac_s_px__9->SetBinContent(3,0.05100819);
   hac_s_px__9->SetBinContent(4,0.04910443);
   hac_s_px__9->SetBinContent(5,0.02384904);
   hac_s_px__9->SetBinError(1,0.007346499);
   hac_s_px__9->SetBinError(2,0.0070293);
   hac_s_px__9->SetBinError(3,0.005226207);
   hac_s_px__9->SetBinError(4,0.006066174);
   hac_s_px__9->SetBinError(5,0.003242962);
   hac_s_px__9->SetEntries(224.3018);
   ...
   hac_s_px__9->GetXaxis()->SetTitle("z");
