...
//=========  (Sun Jun 17 20:05:40 2018) by ROOT version 6.12/06
   ...
   c->SetFrameBorderMode(0);
   Double_t xAxis10[6] = {0.5, 0.6, 0.7, 0.8, 0.9, 1}; 
   
   TH1D *hac_l_px__10 = new TH1D("hac_l_px__10","Acceptance of events from liquid target",5, xAxis10);
   hac_l_px__10->SetBinContent(1,0.04566148);
   hac_l_px__10->SetBinContent(2,0.03906904);
   hac_l_px__10->SetBinContent(3,0.05091424);
   hac_l_px__10->SetBinContent(4,0.04941588);
   hac_l_px__10->SetBinContent(5,0.0258012);
   hac_l_px__10->SetBinError(1,0.01017767);
   hac_l_px__10->SetBinError(2,0.006733963);
   hac_l_px__10->SetBinError(3,0.003728975);
   hac_l_px__10->SetBinError(4,0.003585113);
   hac_l_px__10->SetBinError(5,0.002784049);
   hac_l_px__10->SetEntries(242.3823);
   ...
   hac_l_px__10->GetXaxis()->SetTitle("z");
