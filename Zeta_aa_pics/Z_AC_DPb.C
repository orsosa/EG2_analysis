...
//=========  (Sun Jun 17 20:05:40 2018) by ROOT version 6.12/06
   ...
   hac_l_px__16->SetBinContent(1,0.04566148);
   hac_l_px__16->SetBinContent(2,0.03906904);
   hac_l_px__16->SetBinContent(3,0.05091424);
   hac_l_px__16->SetBinContent(4,0.04941588);
   hac_l_px__16->SetBinContent(5,0.0258012);
   hac_l_px__16->SetBinError(1,0.01017767);
   hac_l_px__16->SetBinError(2,0.006733963);
   hac_l_px__16->SetBinError(3,0.003728975);
   hac_l_px__16->SetBinError(4,0.003585113);
   hac_l_px__16->SetBinError(5,0.002784049);
   hac_l_px__16->SetEntries(242.3823);
   ...
   hac_l_px__16->GetXaxis()->SetTitle("z");
