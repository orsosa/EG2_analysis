...
//=========  (Sat Mar 10 02:10:05 2018) by ROOT version5.34/34
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.325,0.3245093,1.075,0.7954727);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Fe->SetBinContent(1,0.6992313);
   hMR_Fe->SetBinContent(2,0.6461381);
   hMR_Fe->SetBinContent(3,0.5892696);
   hMR_Fe->SetBinContent(4,0.4986969);
   hMR_Fe->SetBinContent(5,0.558446);
   hMR_Fe->SetBinContent(6,0.4303912);
   hMR_Fe->SetBinError(1,0.03120363);
   hMR_Fe->SetBinError(2,0.03776917);
   hMR_Fe->SetBinError(3,0.03542262);
   hMR_Fe->SetBinError(4,0.03510905);
   hMR_Fe->SetBinError(5,0.02417984);
   hMR_Fe->SetBinError(6,0.04169843);
   hMR_Fe->SetEntries(6);
   hMR_Fe->SetStats(0);
