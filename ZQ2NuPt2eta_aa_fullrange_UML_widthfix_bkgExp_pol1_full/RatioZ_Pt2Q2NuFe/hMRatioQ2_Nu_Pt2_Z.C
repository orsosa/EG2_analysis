...
//=========  (Sat Mar 10 02:10:04 2018) by ROOT version5.34/34
   ...
   hMRatio->SetBinError(4,0.01161815);
   hMRatio->SetBinError(7,0.01316891);
   hMRatio->SetBinError(10,0.01376217);
   hMRatio->SetBinError(13,0.01372897);
   hMRatio->SetBinError(16,0.01656143);
   hMRatio->SetBinError(19,0.01730339);
