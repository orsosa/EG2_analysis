...
//=========  (Sat Mar 10 02:10:23 2018) by ROOT version5.34/34
   ...
   c->Range(0.325,0.5672864,1.075,1.212347);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C->SetBinContent(1,0.908776);
   hMR_C->SetBinContent(2,0.857815);
   hMR_C->SetBinContent(3,1.0096);
   hMR_C->SetBinContent(4,1.055992);
   hMR_C->SetBinContent(5,0.7026398);
   hMR_C->SetBinContent(6,0.8527017);
   hMR_C->SetBinError(1,0.1233323);
   hMR_C->SetBinError(2,0.06979932);
   hMR_C->SetBinError(3,0.08585189);
   hMR_C->SetBinError(4,0.06727439);
   hMR_C->SetBinError(5,0.04744381);
   hMR_C->SetBinError(6,0.04161457);
   hMR_C->SetEntries(6);
   hMR_C->SetStats(0);
