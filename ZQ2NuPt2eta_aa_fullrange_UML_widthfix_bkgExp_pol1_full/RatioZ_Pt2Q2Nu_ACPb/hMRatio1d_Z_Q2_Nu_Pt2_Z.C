...
//=========  (Sat Mar 10 02:12:34 2018) by ROOT version5.34/34
   ...
   c->Range(0.325,0.02479851,1.075,0.9116158);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Pb->SetBinContent(1,0.7148701);
   hMR_Pb->SetBinContent(2,0.7597157);
   hMR_Pb->SetBinContent(3,0.600087);
   hMR_Pb->SetBinContent(4,0.7878065);
   hMR_Pb->SetBinContent(5,0.7237899);
   hMR_Pb->SetBinContent(6,0.1512899);
   hMR_Pb->SetBinError(1,0.0008310862);
   hMR_Pb->SetBinError(2,0.0009988722);
   hMR_Pb->SetBinError(3,0.001051571);
   hMR_Pb->SetBinError(4,0.00134408);
   hMR_Pb->SetBinError(5,0.0008320219);
   hMR_Pb->SetBinError(6,0.005634884);
   hMR_Pb->SetEntries(6);
   hMR_Pb->SetStats(0);
