...
//=========  (Wed Jun 20 06:41:32 2018) by ROOT version 6.12/06
   ...
   c1->Range(-0.25,-0.1376874,1.75,1.239186);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetTickx(1);
   ...
   R_pt2_stack_2->SetMaximum(1.101499);
   ...
   TH1D *hRpt2_C_stack_1 = new TH1D("hRpt2_C_stack_1","Multiplicity Ratio",5, xAxis20);
   ...
   hRpt2_C_stack_1->SetBinContent(4,0.8639148);
   hRpt2_C_stack_1->SetBinContent(5,1.049046);
   hRpt2_C_stack_1->SetBinError(1,0.004747965);
   hRpt2_C_stack_1->SetBinError(2,0.007451212);
   hRpt2_C_stack_1->SetBinError(3,0.011861);
   hRpt2_C_stack_1->SetBinError(4,0.01929341);
   hRpt2_C_stack_1->SetBinError(5,0.02472189);
   hRpt2_C_stack_1->SetEntries(14503.5);
   ...
   TH1D *hRpt2_Fe_stack_2 = new TH1D("hRpt2_Fe_stack_2","Multiplicity Ratio",5, xAxis21);
   ...
   TH1D *hRpt2_Pb_stack_3 = new TH1D("hRpt2_Pb_stack_3","Multiplicity Ratio",5, xAxis22);
   ...
   hRpt2_Pb_stack_3->SetBinContent(4,0.5395103);
   hRpt2_Pb_stack_3->SetBinContent(5,0.7636454);
   ...
   hRpt2_Pb_stack_3->SetBinError(4,0.01593868);
   hRpt2_Pb_stack_3->SetBinError(5,0.02244598);
   hRpt2_Pb_stack_3->SetEntries(7132.935);
