...
//=========  (Wed Jun 20 06:58:45 2018) by ROOT version 6.12/06
   ...
   c1->Range(0.4833333,-0.0005003675,4.616667,0.004503307);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetTickx(1);
   ...
   hq2l__13->SetBinContent(1,0.001477585);
   hq2l__13->SetBinContent(2,0.002780939);
   hq2l__13->SetBinContent(3,0.003456258);
   hq2l__13->SetBinContent(4,0.003791383);
   hq2l__13->SetBinContent(5,0.003351886);
   hq2l__13->SetBinError(1,5.686751e-06);
   hq2l__13->SetBinError(2,1.114686e-05);
   hq2l__13->SetBinError(3,1.67796e-05);
   hq2l__13->SetBinError(4,2.094003e-05);
   hq2l__13->SetBinError(5,2.410592e-05);
   hq2l__13->SetEntries(151442.4);
   ...
   ptstats_LaTex = ptstats->AddText("Entries = 151442 ");
   ptstats_LaTex = ptstats->AddText("Mean  =   2.14");
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.7081");
   ...
   hq2s__14->SetBinContent(1,0.0008935937);
   hq2s__14->SetBinContent(2,0.001659507);
   hq2s__14->SetBinContent(3,0.002098401);
   hq2s__14->SetBinContent(4,0.002362519);
   hq2s__14->SetBinContent(5,0.002164684);
   hq2s__14->SetBinError(1,4.581655e-06);
   hq2s__14->SetBinError(2,8.908588e-06);
   hq2s__14->SetBinError(3,1.364454e-05);
   hq2s__14->SetBinError(4,1.734224e-05);
   hq2s__14->SetBinError(5,2.065937e-05);
   hq2s__14->SetEntries(83078);
