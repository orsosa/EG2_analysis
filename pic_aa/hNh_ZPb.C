...
//=========  (Wed Jun 20 06:59:29 2018) by ROOT version 6.12/06
   ...
   c1->Range(0.1833333,-11486.52,1.116667,103378.7);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetTickx(1);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = 0.6532");
   ptstats_LaTex = ptstats->AddText("Std Dev   =  0.127");
