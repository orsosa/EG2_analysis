...
//=========  (Wed Jun 20 06:58:45 2018) by ROOT version 6.12/06
   ...
   c1->Range(0.1833333,-13718.88,1.116667,123469.9);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetTickx(1);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = 0.6547");
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.1273");
