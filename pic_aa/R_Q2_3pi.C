...
//=========  (Wed Jun 20 06:41:32 2018) by ROOT version 6.12/06
   ...
   c1->Range(0.4833333,-0.102048,4.616667,0.9184318);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetTickx(1);
   ...
   R_q2_stack_3->SetMaximum(0.8163838);
   ...
   TH1D *hRq2_C_stack_1 = new TH1D("hRq2_C_stack_1","Multiplicity Ratio",5, xAxis24);
   hRq2_C_stack_1->SetBinContent(1,0.7397465);
   hRq2_C_stack_1->SetBinContent(2,0.730826);
   hRq2_C_stack_1->SetBinContent(3,0.7618525);
   hRq2_C_stack_1->SetBinContent(4,0.7499844);
   hRq2_C_stack_1->SetBinContent(5,0.7775084);
   hRq2_C_stack_1->SetBinError(1,0.006510379);
   hRq2_C_stack_1->SetBinError(2,0.007015513);
   hRq2_C_stack_1->SetBinError(3,0.008998967);
   hRq2_C_stack_1->SetBinError(4,0.01006221);
   hRq2_C_stack_1->SetBinError(5,0.01346354);
   hRq2_C_stack_1->SetEntries(31063.54);
   ...
   TH1D *hRq2_Fe_stack_2 = new TH1D("hRq2_Fe_stack_2","Multiplicity Ratio",5, xAxis25);
   hRq2_Fe_stack_2->SetBinContent(1,0.5320429);
   hRq2_Fe_stack_2->SetBinContent(2,0.5088762);
   hRq2_Fe_stack_2->SetBinContent(3,0.5190718);
   hRq2_Fe_stack_2->SetBinContent(4,0.5191988);
   hRq2_Fe_stack_2->SetBinContent(5,0.5332971);
   hRq2_Fe_stack_2->SetBinError(1,0.004025774);
   hRq2_Fe_stack_2->SetBinError(2,0.004219579);
   hRq2_Fe_stack_2->SetBinError(3,0.005320755);
   hRq2_Fe_stack_2->SetBinError(4,0.006111562);
   hRq2_Fe_stack_2->SetBinError(5,0.008242222);
   hRq2_Fe_stack_2->SetEntries(40720.64);
   ...
   TH1D *hRq2_Pb_stack_3 = new TH1D("hRq2_Pb_stack_3","Multiplicity Ratio",5, xAxis26);
   hRq2_Pb_stack_3->SetBinContent(1,0.3887542);
   hRq2_Pb_stack_3->SetBinContent(2,0.3940918);
   hRq2_Pb_stack_3->SetBinContent(3,0.4037519);
   hRq2_Pb_stack_3->SetBinContent(4,0.3940173);
   hRq2_Pb_stack_3->SetBinContent(5,0.4375674);
   hRq2_Pb_stack_3->SetBinError(1,0.004707823);
   hRq2_Pb_stack_3->SetBinError(2,0.005198544);
   hRq2_Pb_stack_3->SetBinError(3,0.006572753);
   hRq2_Pb_stack_3->SetBinError(4,0.007514896);
   hRq2_Pb_stack_3->SetBinError(5,0.01073502);
   hRq2_Pb_stack_3->SetEntries(15422.19);
