...
//=========  (Wed Jun 20 06:57:34 2018) by ROOT version 6.12/06
   TCanvas *c1 = new TCanvas("c1", "c1",1,1,1024,744);
   c1->Range(0.4833333,-0.0005339205,4.616667,0.004805284);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetTickx(1);
   ...
   hq2l__5->SetBinContent(1,0.001596589);
   hq2l__5->SetBinContent(2,0.002956841);
   hq2l__5->SetBinContent(3,0.003648872);
   hq2l__5->SetBinContent(4,0.004039054);
   hq2l__5->SetBinContent(5,0.003510729);
   hq2l__5->SetBinError(1,7.854817e-06);
   hq2l__5->SetBinError(2,1.538242e-05);
   hq2l__5->SetBinError(3,2.31104e-05);
   hq2l__5->SetBinError(4,2.891125e-05);
   hq2l__5->SetBinError(5,3.295587e-05);
   hq2l__5->SetEntries(90085.68);
   ...
   ptstats_LaTex = ptstats->AddText("Entries = 90086  ");
   ptstats_LaTex = ptstats->AddText("Mean  =  2.135");
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.7069");
   ...
   hq2s__6->SetBinContent(1,0.0013274);
   hq2s__6->SetBinContent(2,0.002477448);
   hq2s__6->SetBinContent(3,0.003044019);
   hq2s__6->SetBinContent(4,0.003361909);
   hq2s__6->SetBinContent(5,0.003032596);
   hq2s__6->SetBinError(1,7.864441e-06);
   hq2s__6->SetBinError(2,1.531395e-05);
   hq2s__6->SetBinError(3,2.30071e-05);
   hq2s__6->SetBinError(4,2.869102e-05);
   hq2s__6->SetBinError(5,3.360487e-05);
   hq2s__6->SetEntries(63130.73);
