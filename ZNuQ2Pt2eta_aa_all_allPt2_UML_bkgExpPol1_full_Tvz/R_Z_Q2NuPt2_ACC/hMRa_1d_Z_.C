...
//=========  (Thu May  3 20:07:07 2018) by ROOT version 6.12/04
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.325,0.4218125,1.075,1.963295);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C__1->SetBinContent(1,1.183206);
   hMR_C__1->SetBinContent(2,0.8644592);
   hMR_C__1->SetBinContent(3,0.8003391);
   hMR_C__1->SetBinContent(4,1.435879);
   hMR_C__1->SetBinContent(5,0.9723934);
   hMR_C__1->SetBinContent(6,1.267875);
   hMR_C__1->SetBinError(1,0.2328433);
   hMR_C__1->SetBinError(2,0.1950857);
   hMR_C__1->SetBinError(3,0.1684516);
   hMR_C__1->SetBinError(4,0.3145446);
   hMR_C__1->SetBinError(5,0.1824888);
   hMR_C__1->SetBinError(6,0.4254818);
   hMR_C__1->SetEntries(98.09181);
   hMR_C__1->SetStats(0);
