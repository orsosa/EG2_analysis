...
//=========  (Thu May  3 20:07:14 2018) by ROOT version 6.12/04
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.325,0.3087137,1.075,0.6515949);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Pb__1->SetBinContent(1,0.4600781);
   hMR_Pb__1->SetBinContent(2,0.5419805);
   hMR_Pb__1->SetBinContent(3,0.4963969);
   hMR_Pb__1->SetBinContent(4,0.4396337);
   hMR_Pb__1->SetBinContent(5,0.4674733);
   hMR_Pb__1->SetBinContent(6,0.4798433);
   hMR_Pb__1->SetBinError(1,0.0885673);
   hMR_Pb__1->SetBinError(2,0.06020798);
   hMR_Pb__1->SetBinError(3,0.09698224);
   hMR_Pb__1->SetBinError(4,0.0648597);
   hMR_Pb__1->SetBinError(5,0.07704903);
   hMR_Pb__1->SetBinError(6,0.1244014);
   hMR_Pb__1->SetEntries(179.0685);
