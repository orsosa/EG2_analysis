...
//=========  (Fri Mar  9 02:06:52 2018) by ROOT version5.34/34
   ...
   c->Range(0.325,0.3642551,1.075,0.5497127);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Pb->SetBinContent(1,0.4470693);
   hMR_Pb->SetBinContent(2,0.5102171);
   hMR_Pb->SetBinContent(3,0.483457);
   hMR_Pb->SetBinContent(4,0.4828209);
   hMR_Pb->SetBinContent(5,0.4669311);
   hMR_Pb->SetBinContent(6,0.4109015);
   hMR_Pb->SetBinError(1,0.00957875);
   hMR_Pb->SetBinError(2,0.0138848);
   hMR_Pb->SetBinError(3,0.01777254);
   hMR_Pb->SetBinError(4,0.01797037);
   hMR_Pb->SetBinError(5,0.01810465);
   hMR_Pb->SetBinError(6,0.02137208);
   hMR_Pb->SetEntries(6);
   hMR_Pb->SetStats(0);
