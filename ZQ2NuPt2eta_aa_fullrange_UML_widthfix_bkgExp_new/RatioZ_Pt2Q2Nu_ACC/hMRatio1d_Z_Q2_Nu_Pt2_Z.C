...
//=========  (Fri Mar  9 02:08:10 2018) by ROOT version5.34/34
   ...
   c->Range(0.325,1.222182,1.075,1.608649);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C->SetBinContent(1,1.384452);
   hMR_C->SetBinContent(2,1.317535);
   hMR_C->SetBinContent(3,1.37029);
   hMR_C->SetBinContent(4,1.550831);
   hMR_C->SetBinContent(5,1.337892);
   hMR_C->SetBinContent(6,1.278201);
   hMR_C->SetBinError(1,0.002063705);
   hMR_C->SetBinError(2,0.002118797);
   hMR_C->SetBinError(3,0.002856264);
   hMR_C->SetBinError(4,0.004448726);
   hMR_C->SetBinError(5,0.003344165);
   hMR_C->SetBinError(6,0.00335043);
   hMR_C->SetEntries(6);
   hMR_C->SetStats(0);
