...
//=========  (Fri Mar  9 02:08:08 2018) by ROOT version5.34/34
   ...
   c->Range(0.325,0.7702187,1.075,1.150824);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Fe->SetBinContent(1,1.09702);
   hMR_Fe->SetBinContent(2,0.9457759);
   hMR_Fe->SetBinContent(3,0.8234643);
   hMR_Fe->SetBinContent(4,0.8747467);
   hMR_Fe->SetBinContent(5,0.9324934);
   hMR_Fe->SetBinContent(6,0.9483603);
   hMR_Fe->SetBinError(1,0.001244205);
   hMR_Fe->SetBinError(2,0.00122);
   hMR_Fe->SetBinError(3,0.001376385);
   hMR_Fe->SetBinError(4,0.001889608);
   hMR_Fe->SetBinError(5,0.001742287);
   hMR_Fe->SetBinError(6,0.002128121);
   hMR_Fe->SetEntries(6);
   hMR_Fe->SetStats(0);
