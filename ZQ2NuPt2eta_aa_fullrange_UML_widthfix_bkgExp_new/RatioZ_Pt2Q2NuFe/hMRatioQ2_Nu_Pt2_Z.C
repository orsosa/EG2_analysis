...
//=========  (Fri Mar  9 02:06:39 2018) by ROOT version5.34/34
   ...
   hMRatio->SetBinError(4,0.009087142);
   hMRatio->SetBinError(7,0.01140058);
   hMRatio->SetBinError(10,0.01385888);
   hMRatio->SetBinError(13,0.01365861);
   hMRatio->SetBinError(16,0.0150276);
   hMRatio->SetBinError(19,0.0218923);
