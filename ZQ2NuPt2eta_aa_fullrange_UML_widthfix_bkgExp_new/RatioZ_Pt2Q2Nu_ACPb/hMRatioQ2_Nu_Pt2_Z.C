...
//=========  (Fri Mar  9 02:08:22 2018) by ROOT version5.34/34
   ...
   hMRatio->SetBinError(4,0.02157659);
   hMRatio->SetBinError(7,0.02798865);
   hMRatio->SetBinError(10,0.02823684);
   hMRatio->SetBinError(13,0.02790258);
   hMRatio->SetBinError(16,0.03021896);
   hMRatio->SetBinError(19,0.03357273);
