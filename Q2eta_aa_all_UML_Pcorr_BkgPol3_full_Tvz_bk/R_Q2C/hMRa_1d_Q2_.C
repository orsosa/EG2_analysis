...
//=========  (Sun Jun 17 22:14:30 2018) by ROOT version 6.12/06
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.6125,0.2965874,4.4875,1.187056);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C__1->SetBinContent(1,0.4889595);
   hMR_C__1->SetBinContent(2,0.8861259);
   hMR_C__1->SetBinContent(3,0.7506213);
   hMR_C__1->SetBinContent(4,0.6222515);
   hMR_C__1->SetBinContent(5,0.7580332);
   hMR_C__1->SetBinError(1,0.07101804);
   hMR_C__1->SetBinError(2,0.1779606);
   hMR_C__1->SetBinError(3,0.1658533);
   hMR_C__1->SetBinError(4,0.1485696);
   hMR_C__1->SetBinError(5,0.1936016);
   hMR_C__1->SetEntries(99.30873);
   hMR_C__1->SetStats(0);
