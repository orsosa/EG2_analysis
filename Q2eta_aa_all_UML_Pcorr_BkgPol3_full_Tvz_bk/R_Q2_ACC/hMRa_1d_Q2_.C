...
//=========  (Sun Jun 17 22:14:37 2018) by ROOT version 6.12/06
   ...
   c->Range(0.6125,0.08355513,4.4875,2.249225);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C__1->SetBinContent(1,0.5911072);
   hMR_C__1->SetBinContent(2,0.8512592);
   hMR_C__1->SetBinContent(3,0.8130466);
   hMR_C__1->SetBinContent(4,0.6015586);
   hMR_C__1->SetBinContent(5,1.245984);
   hMR_C__1->SetBinError(1,0.1320272);
   hMR_C__1->SetBinError(2,0.2329477);
   hMR_C__1->SetBinError(3,0.2206418);
   hMR_C__1->SetBinError(4,0.2228634);
   hMR_C__1->SetBinError(5,0.7041724);
   hMR_C__1->SetEntries(25.28024);
   hMR_C__1->SetStats(0);
