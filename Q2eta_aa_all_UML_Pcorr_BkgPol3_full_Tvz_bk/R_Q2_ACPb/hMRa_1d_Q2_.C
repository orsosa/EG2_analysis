...
//=========  (Sun Jun 17 22:14:38 2018) by ROOT version 6.12/06
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.6125,-0.09247569,4.4875,0.9734145);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Pb__1->SetBinContent(1,0.2349097);
   hMR_Pb__1->SetBinContent(2,0.2216994);
   hMR_Pb__1->SetBinContent(3,0.2811631);
   hMR_Pb__1->SetBinContent(4,0.208484);
   hMR_Pb__1->SetBinContent(5,0.5356163);
   hMR_Pb__1->SetBinError(1,0.05492743);
   hMR_Pb__1->SetBinError(2,0.05161767);
   hMR_Pb__1->SetBinError(3,0.228378);
   hMR_Pb__1->SetBinError(4,0.07903921);
   hMR_Pb__1->SetBinError(5,0.2906039);
   hMR_Pb__1->SetEntries(14.78396);
