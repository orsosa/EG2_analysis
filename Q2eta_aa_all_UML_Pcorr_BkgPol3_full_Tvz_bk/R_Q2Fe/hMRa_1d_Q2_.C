...
//=========  (Sun Jun 17 22:14:30 2018) by ROOT version 6.12/06
   ...
   c->Range(0.6125,-0.06618677,4.4875,1.002928);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Fe__1->SetBinContent(1,0.580362);
   hMR_Fe__1->SetBinContent(2,0.338516);
   hMR_Fe__1->SetBinContent(3,0.4836475);
   hMR_Fe__1->SetBinContent(4,0.7047196);
   hMR_Fe__1->SetBinContent(5,0.4674008);
   hMR_Fe__1->SetBinError(1,0.07048679);
   hMR_Fe__1->SetBinError(2,0.03774775);
   hMR_Fe__1->SetBinError(3,0.08831162);
   hMR_Fe__1->SetBinError(4,0.1165302);
   hMR_Fe__1->SetBinError(5,0.3878873);
   hMR_Fe__1->SetEntries(37.1928);
