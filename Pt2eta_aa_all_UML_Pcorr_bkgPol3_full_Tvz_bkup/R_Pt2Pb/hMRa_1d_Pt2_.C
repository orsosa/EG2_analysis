...
//=========  (Mon Jun 11 20:19:48 2018) by ROOT version 6.12/06
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(-0.1875,0.1130928,1.6875,1.366251);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Pb__1->SetBinContent(1,0.5000883);
   hMR_Pb__1->SetBinContent(2,0.5968628);
   hMR_Pb__1->SetBinContent(3,0.391305);
   hMR_Pb__1->SetBinContent(4,0.6224285);
   hMR_Pb__1->SetBinContent(5,0.8407272);
   hMR_Pb__1->SetBinError(1,0.1072449);
   hMR_Pb__1->SetBinError(2,0.1289514);
   hMR_Pb__1->SetBinError(3,0.1074303);
   hMR_Pb__1->SetBinError(4,0.1886061);
   hMR_Pb__1->SetBinError(5,0.3524688);
   hMR_Pb__1->SetEntries(43.66819);
