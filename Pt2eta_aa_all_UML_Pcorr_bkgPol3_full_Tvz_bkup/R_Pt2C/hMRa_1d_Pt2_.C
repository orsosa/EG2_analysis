...
//=========  (Mon Jun 11 20:19:47 2018) by ROOT version 6.12/06
   ...
   c->Range(-0.1875,-0.06485074,1.6875,3.428439);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C__1->SetBinContent(1,0.8099967);
   hMR_C__1->SetBinContent(2,0.7524646);
   hMR_C__1->SetBinContent(3,1.242101);
   hMR_C__1->SetBinContent(4,0.5854592);
   hMR_C__1->SetBinContent(5,1.968769);
   hMR_C__1->SetBinError(1,0.1333695);
   hMR_C__1->SetBinError(2,0.1367111);
   hMR_C__1->SetBinError(3,0.2554512);
   hMR_C__1->SetBinError(4,0.1742402);
   hMR_C__1->SetBinError(5,0.9772637);
   hMR_C__1->SetEntries(26.41492);
   hMR_C__1->SetStats(0);
