...
//=========  (Mon Jun 11 20:19:53 2018) by ROOT version 6.12/06
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(-0.1875,0.05751768,1.6875,1.309877);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Pb__1->SetBinContent(1,0.4210734);
   hMR_Pb__1->SetBinContent(2,0.6137134);
   hMR_Pb__1->SetBinContent(3,0.5126958);
   hMR_Pb__1->SetBinContent(4,0.7051);
   hMR_Pb__1->SetBinContent(5,0.7911052);
   hMR_Pb__1->SetBinError(1,0.1928827);
   hMR_Pb__1->SetBinError(2,0.1930014);
   hMR_Pb__1->SetBinError(3,0.1614356);
   hMR_Pb__1->SetBinError(4,0.2395198);
   hMR_Pb__1->SetBinError(5,0.3458271);
   hMR_Pb__1->SetEntries(33.38622);
