...
//=========  (Wed Jun 20 07:06:51 2018) by ROOT version 6.12/06
   ...
   c1->Range(0.4166667,-7049.34,1.083333,63444.06);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetTickx(1);
   ...
   c1->SetFrameBorderMode(0);
   Double_t xAxis1[5] = {0.5, 0.6, 0.7, 0.8, 1}; 
   
   TH1D *hzl__1 = new TH1D("hzl__1","z solid data",4, xAxis1);
   hzl__1->SetBinContent(1,53478);
   hzl__1->SetBinContent(2,28322);
   hzl__1->SetBinContent(3,14346);
   hzl__1->SetBinContent(4,10218);
   hzl__1->SetBinError(1,231.2531);
   hzl__1->SetBinError(2,168.2914);
   hzl__1->SetBinError(3,119.7748);
   hzl__1->SetBinError(4,101.0841);
   hzl__1->SetEntries(106364);
   ...
   ptstats_LaTex = ptstats->AddText("Entries = 106364 ");
   ptstats_LaTex = ptstats->AddText("Mean  = 0.6301");
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.1104");
   ...
   hzl__1->Draw("p");
   Double_t xAxis2[5] = {0.5, 0.6, 0.7, 0.8, 1}; 
   
   TH1D *hzs__2 = new TH1D("hzs__2","z solid data",4, xAxis2);
   hzs__2->SetBinContent(1,33656);
   hzs__2->SetBinContent(2,17521);
   hzs__2->SetBinContent(3,8730);
   hzs__2->SetBinContent(4,6247);
   hzs__2->SetBinError(1,183.4557);
   hzs__2->SetBinError(2,132.3669);
   hzs__2->SetBinError(3,93.43447);
   hzs__2->SetBinError(4,79.03797);
   hzs__2->SetEntries(66154);
