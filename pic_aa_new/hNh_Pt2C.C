...
//=========  (Wed Jun 20 07:06:51 2018) by ROOT version 6.12/06
   ...
   c1->Range(-0.25,-7882.688,1.75,70944.19);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetTickx(1);
   ...
   hpt2l__3->SetBinContent(1,59814);
   hpt2l__3->SetBinContent(2,26393);
   hpt2l__3->SetBinContent(3,11498);
   hpt2l__3->SetBinContent(4,8659);
   hpt2l__3->SetBinError(1,244.569);
   hpt2l__3->SetBinError(2,162.4592);
   hpt2l__3->SetBinError(3,107.2287);
   hpt2l__3->SetBinError(4,93.05375);
   hpt2l__3->SetEntries(106364);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = 0.2168");
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.2165");
   ...
   hpt2s__4->SetBinContent(1,35153);
   hpt2s__4->SetBinContent(2,16477);
   hpt2s__4->SetBinContent(3,7706);
   hpt2s__4->SetBinContent(4,6818);
   hpt2s__4->SetBinError(1,187.4913);
   hpt2s__4->SetBinError(2,128.3628);
   hpt2s__4->SetBinError(3,87.78383);
   hpt2s__4->SetBinError(4,82.57118);
   hpt2s__4->SetEntries(66154);
