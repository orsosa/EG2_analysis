...
//=========  (Wed Jun 20 07:09:15 2018) by ROOT version 6.12/06
   ...
   c1->Range(0.4166667,-9775.423,1.083333,87978.8);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetTickx(1);
   ...
   hzl__17->SetBinContent(1,74207);
   hzl__17->SetBinContent(2,38850);
   hzl__17->SetBinContent(3,19599);
   hzl__17->SetBinContent(4,14100);
   hzl__17->SetBinError(1,272.4096);
   hzl__17->SetBinError(2,197.104);
   hzl__17->SetBinError(3,139.9964);
   hzl__17->SetBinError(4,118.7434);
   hzl__17->SetEntries(146756);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = 0.6297");
   ...
   hzs__18->SetBinContent(1,12450);
   hzs__18->SetBinContent(2,6445);
   hzs__18->SetBinContent(3,3196);
   hzs__18->SetBinContent(4,2433);
   hzs__18->SetBinError(1,111.5796);
   hzs__18->SetBinError(2,80.28076);
   hzs__18->SetBinError(3,56.53318);
   hzs__18->SetBinError(4,49.32545);
   hzs__18->SetEntries(24524);
