...
//=========  (Wed Jan 17 14:41:16 2018) by ROOT version5.34/36
   ...
   cmp0->Range(-13.33333,-6.5625,13.33333,59.0625);
   cmp0->SetFillColor(0);
   ...
   TH1F *hcmp0 = new TH1F("hcmp0","Radiative correction relative difference Pb",100,-10,10);
   ...
   pt->SetFillColor(0);
   pt->SetTextFont(22);
   text = pt->AddText("Radiative correction relative difference Pb");
   pt->Draw();
   cmp0->Modified();
   cmp0->cd();
