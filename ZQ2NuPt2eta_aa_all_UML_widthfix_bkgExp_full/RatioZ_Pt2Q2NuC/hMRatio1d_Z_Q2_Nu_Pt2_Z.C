...
//=========  (Fri Mar 16 01:10:16 2018) by ROOT version5.34/34
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.325,0.7122602,1.075,1.08249);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C->SetBinContent(1,0.8265217);
   hMR_C->SetBinContent(2,0.8464399);
   hMR_C->SetBinContent(3,0.9679787);
   hMR_C->SetBinContent(4,0.9334525);
   hMR_C->SetBinContent(5,0.8204605);
   hMR_C->SetBinContent(6,0.8518703);
   hMR_C->SetBinError(1,0.0303963);
   hMR_C->SetBinError(2,0.04382569);
   hMR_C->SetBinError(3,0.06338426);
   hMR_C->SetBinError(4,0.06649612);
   hMR_C->SetBinError(5,0.05774497);
   hMR_C->SetBinError(6,0.07726406);
   hMR_C->SetEntries(6);
   hMR_C->SetStats(0);
