...
//=========  (Fri Mar 16 01:10:15 2018) by ROOT version5.34/34
   ...
   hMRatio->SetBinError(4,0.01493478);
   hMRatio->SetBinError(7,0.01990513);
   hMRatio->SetBinError(10,0.02795453);
   hMRatio->SetBinError(13,0.03026687);
   hMRatio->SetBinError(16,0.0281992);
   hMRatio->SetBinError(19,0.03586649);
