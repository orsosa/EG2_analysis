...
//=========  (Fri Mar 16 01:10:13 2018) by ROOT version5.34/34
   ...
   c->Range(0.325,0.4632996,1.075,0.7027257);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Fe->SetBinContent(1,0.6515877);
   hMR_Fe->SetBinContent(2,0.5967366);
   hMR_Fe->SetBinContent(3,0.58006);
   hMR_Fe->SetBinContent(4,0.5254698);
   hMR_Fe->SetBinContent(5,0.5478075);
   hMR_Fe->SetBinContent(6,0.607779);
   hMR_Fe->SetBinError(1,0.01807435);
   hMR_Fe->SetBinError(2,0.02532151);
   hMR_Fe->SetBinError(3,0.03161522);
   hMR_Fe->SetBinError(4,0.02954098);
   hMR_Fe->SetBinError(5,0.0296466);
   hMR_Fe->SetBinError(6,0.04790209);
   hMR_Fe->SetEntries(6);
   hMR_Fe->SetStats(0);
