...
//=========  (Fri Mar 16 01:10:29 2018) by ROOT version5.34/34
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.325,0.3404905,1.075,0.5810724);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Pb->SetBinContent(1,0.5039413);
   hMR_Pb->SetBinContent(2,0.4901189);
   hMR_Pb->SetBinContent(3,0.5009753);
   hMR_Pb->SetBinContent(4,0.5466564);
   hMR_Pb->SetBinContent(5,0.4630969);
   hMR_Pb->SetBinContent(6,0.3742403);
   hMR_Pb->SetBinError(1,0.0006416772);
   hMR_Pb->SetBinError(2,0.0006488243);
   hMR_Pb->SetBinError(3,0.0008458084);
   hMR_Pb->SetBinError(4,0.001192722);
   hMR_Pb->SetBinError(5,0.0009847472);
   hMR_Pb->SetBinError(6,0.0009630432);
   hMR_Pb->SetEntries(6);
   hMR_Pb->SetStats(0);
