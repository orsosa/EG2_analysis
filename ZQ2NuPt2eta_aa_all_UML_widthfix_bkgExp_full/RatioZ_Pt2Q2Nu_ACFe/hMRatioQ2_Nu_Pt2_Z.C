...
//=========  (Fri Mar 16 01:10:24 2018) by ROOT version5.34/34
   ...
   hMRatio->SetBinError(4,0.02553702);
   hMRatio->SetBinError(7,0.0265261);
   hMRatio->SetBinError(10,0.02666636);
   hMRatio->SetBinError(13,0.02329619);
   hMRatio->SetBinError(16,0.02699581);
   hMRatio->SetBinError(19,0.03799908);
