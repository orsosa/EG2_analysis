...
//=========  (Fri Mar 16 01:10:24 2018) by ROOT version5.34/34
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.325,0.520126,1.075,0.7543677);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Fe->SetBinContent(1,0.7209716);
   hMR_Fe->SetBinContent(2,0.6104982);
   hMR_Fe->SetBinContent(3,0.5532911);
   hMR_Fe->SetBinContent(4,0.5854042);
   hMR_Fe->SetBinContent(5,0.602176);
   hMR_Fe->SetBinContent(6,0.5793236);
   hMR_Fe->SetBinError(1,0.001048417);
   hMR_Fe->SetBinError(2,0.001048282);
   hMR_Fe->SetBinError(3,0.001242435);
   hMR_Fe->SetBinError(4,0.001664511);
   hMR_Fe->SetBinError(5,0.001477378);
   hMR_Fe->SetBinError(6,0.001791058);
   hMR_Fe->SetEntries(6);
   hMR_Fe->SetStats(0);
