...
//=========  (Fri Mar 16 01:10:18 2018) by ROOT version5.34/34
   ...
   hMRatio->SetBinError(4,0.01107079);
   hMRatio->SetBinError(7,0.01475043);
   hMRatio->SetBinError(10,0.0197359);
   hMRatio->SetBinError(13,0.02057786);
   hMRatio->SetBinError(16,0.01999018);
   hMRatio->SetBinError(19,0.02303326);
