...
//=========  (Fri Mar 16 01:10:18 2018) by ROOT version5.34/34
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.325,0.3334534,1.075,0.5807513);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Pb->SetBinContent(1,0.4554437);
   hMR_Pb->SetBinContent(2,0.4790709);
   hMR_Pb->SetBinContent(3,0.525213);
   hMR_Pb->SetBinContent(4,0.490689);
   hMR_Pb->SetBinContent(5,0.4212855);
   hMR_Pb->SetBinContent(6,0.3926224);
   hMR_Pb->SetBinError(1,0.01136);
   hMR_Pb->SetBinError(2,0.0157534);
   hMR_Pb->SetBinError(3,0.02138765);
   hMR_Pb->SetBinError(4,0.02146852);
   hMR_Pb->SetBinError(5,0.02013976);
   hMR_Pb->SetBinError(6,0.02546696);
   hMR_Pb->SetEntries(6);
   hMR_Pb->SetStats(0);
