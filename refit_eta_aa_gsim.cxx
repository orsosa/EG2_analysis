{
  ...
  TString fname= "Q2eta_aa_all_UML_Pcorr_BkgPol3_full_Tvz/gsim_CD_Cgsim/binned.root";
  Nbins=5;
...
//    c->Draw();
    ...
    *Neta=300000;
    ...
    RooRealVar m_g("m_g","mean pi0",0.55,0.54,0.56);
    ...
    ds->plotOn(pl,RooFit::Binning(1e4,0.2,0.8));
