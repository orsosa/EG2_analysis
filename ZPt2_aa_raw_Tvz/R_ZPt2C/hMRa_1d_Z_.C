...
//=========  (Thu Jun 21 18:41:40 2018) by ROOT version 6.12/06
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.2125,0.7012206,1.0875,0.8677889);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C__1->SetBinContent(1,0.8193911);
   hMR_C__1->SetBinContent(2,0.8086013);
   hMR_C__1->SetBinContent(3,0.8119653);
   hMR_C__1->SetBinContent(4,0.8087814);
   hMR_C__1->SetBinContent(5,0.8292082);
   hMR_C__1->SetBinContent(6,0.8101271);
   hMR_C__1->SetBinContent(7,0.7480395);
   hMR_C__1->SetBinError(1,0.003896429);
   hMR_C__1->SetBinError(2,0.005514166);
   hMR_C__1->SetBinError(3,0.007901405);
   hMR_C__1->SetBinError(4,0.01118092);
   hMR_C__1->SetBinError(5,0.01557835);
   hMR_C__1->SetBinError(6,0.02011981);
   hMR_C__1->SetBinError(7,0.0241188);
   hMR_C__1->SetEntries(21724.02);
   hMR_C__1->SetStats(0);
