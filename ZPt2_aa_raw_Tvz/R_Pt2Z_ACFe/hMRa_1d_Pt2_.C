...
//=========  (Thu Jun 21 18:43:38 2018) by ROOT version 6.12/06
   ...
   c->Range(-0.1875,0.05586968,1.6875,3.652457);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Fe__1->SetBinContent(1,0.5506823);
   hMR_Fe__1->SetBinContent(2,0.6120767);
   hMR_Fe__1->SetBinContent(3,0.7216814);
   hMR_Fe__1->SetBinContent(4,0.9099396);
   hMR_Fe__1->SetBinContent(5,1.171455);
   hMR_Fe__1->SetBinContent(6,1.46396);
   hMR_Fe__1->SetBinContent(7,2.79394);
   hMR_Fe__1->SetBinError(1,0.004665382);
   hMR_Fe__1->SetBinError(2,0.007512334);
   hMR_Fe__1->SetBinError(3,0.013232);
   hMR_Fe__1->SetBinError(4,0.02549239);
   hMR_Fe__1->SetBinError(5,0.05333671);
   hMR_Fe__1->SetBinError(6,0.1089889);
   hMR_Fe__1->SetBinError(7,0.3618458);
   hMR_Fe__1->SetEntries(461.4515);
