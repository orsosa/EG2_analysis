...
//=========  (Thu Jun 21 18:45:38 2018) by ROOT version 6.12/06
   ...
   c->Range(-0.1875,-0.1174925,1.6875,2.117976);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C__1->SetBinContent(1,0.7518939);
   hMR_C__1->SetBinContent(2,0.7562054);
   hMR_C__1->SetBinContent(3,0.926946);
   hMR_C__1->SetBinContent(4,0.9611824);
   hMR_C__1->SetBinContent(5,1.015682);
   hMR_C__1->SetBinContent(6,0.5443215);
   hMR_C__1->SetBinContent(7,1.198777);
   hMR_C__1->SetBinError(1,0.01404488);
   hMR_C__1->SetBinError(2,0.02059991);
   hMR_C__1->SetBinError(3,0.0404324);
   hMR_C__1->SetBinError(4,0.07340051);
   hMR_C__1->SetBinError(5,0.1181346);
   hMR_C__1->SetBinError(6,0.3571617);
   hMR_C__1->SetBinError(7,0.6104909);
   hMR_C__1->SetEntries(72.59395);
   hMR_C__1->SetStats(0);
