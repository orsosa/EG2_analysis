...
//=========  (Thu Jun 21 18:46:02 2018) by ROOT version 6.12/06
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.2125,0.3235393,1.0875,0.478208);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Pb__1->SetBinContent(1,0.4276361);
   hMR_Pb__1->SetBinContent(2,0.406121);
   hMR_Pb__1->SetBinContent(3,0.4078799);
   hMR_Pb__1->SetBinContent(4,0.3780251);
   hMR_Pb__1->SetBinContent(5,0.3558835);
   hMR_Pb__1->SetBinContent(6,0.4106666);
   hMR_Pb__1->SetBinContent(7,0.4297);
   hMR_Pb__1->SetBinError(1,0.005706786);
   hMR_Pb__1->SetBinError(2,0.00554143);
   hMR_Pb__1->SetBinError(3,0.006731769);
   hMR_Pb__1->SetBinError(4,0.008417615);
   hMR_Pb__1->SetBinError(5,0.01126578);
   hMR_Pb__1->SetBinError(6,0.01778088);
   hMR_Pb__1->SetBinError(7,0.027149);
   hMR_Pb__1->SetEntries(5832.156);
