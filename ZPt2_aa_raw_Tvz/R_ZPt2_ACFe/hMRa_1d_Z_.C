...
//=========  (Thu Jun 21 18:41:45 2018) by ROOT version 6.12/06
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.2125,0.4209867,1.0875,0.6572502);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Fe__1->SetBinContent(1,0.6189092);
   hMR_Fe__1->SetBinContent(2,0.6060894);
   hMR_Fe__1->SetBinContent(3,0.5875312);
   hMR_Fe__1->SetBinContent(4,0.595094);
   hMR_Fe__1->SetBinContent(5,0.5704561);
   hMR_Fe__1->SetBinContent(6,0.5391347);
   hMR_Fe__1->SetBinContent(7,0.4800085);
   hMR_Fe__1->SetBinError(1,0.005714087);
   hMR_Fe__1->SetBinError(2,0.007503575);
   hMR_Fe__1->SetBinError(3,0.0100437);
   hMR_Fe__1->SetBinError(4,0.01374846);
   hMR_Fe__1->SetBinError(5,0.01718055);
   hMR_Fe__1->SetBinError(6,0.02028077);
   hMR_Fe__1->SetBinError(7,0.02682346);
   hMR_Fe__1->SetEntries(8852.799);
