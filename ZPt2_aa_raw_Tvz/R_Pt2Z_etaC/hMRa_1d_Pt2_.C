...
//=========  (Thu Jun 21 18:46:29 2018) by ROOT version 6.12/06
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(-0.1875,0.6562909,1.6875,1.341732);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C__1->SetBinContent(1,0.7543651);
   hMR_C__1->SetBinContent(2,0.7868371);
   hMR_C__1->SetBinContent(3,0.8993989);
   hMR_C__1->SetBinContent(4,0.9493134);
   hMR_C__1->SetBinContent(5,0.9650743);
   hMR_C__1->SetBinContent(6,0.903627);
   hMR_C__1->SetBinContent(7,1.101092);
   hMR_C__1->SetBinError(1,0.004661434);
   hMR_C__1->SetBinError(2,0.009829013);
   hMR_C__1->SetBinError(3,0.02071658);
   hMR_C__1->SetBinError(4,0.03875237);
   hMR_C__1->SetBinError(5,0.0606812);
   hMR_C__1->SetBinError(6,0.08044944);
   hMR_C__1->SetBinError(7,0.1459837);
   hMR_C__1->SetEntries(1206.806);
   hMR_C__1->SetStats(0);
