...
//=========  (Thu Jun 21 18:41:46 2018) by ROOT version 6.12/06
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.2125,0.2864471,1.0875,0.5100004);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Pb__1->SetBinContent(1,0.4740238);
   hMR_Pb__1->SetBinContent(2,0.4499151);
   hMR_Pb__1->SetBinContent(3,0.4350147);
   hMR_Pb__1->SetBinContent(4,0.4326365);
   hMR_Pb__1->SetBinContent(5,0.4234608);
   hMR_Pb__1->SetBinContent(6,0.3959969);
   hMR_Pb__1->SetBinContent(7,0.3417313);
   hMR_Pb__1->SetBinError(1,0.005104882);
   hMR_Pb__1->SetBinError(2,0.006461296);
   hMR_Pb__1->SetBinError(3,0.008652784);
   hMR_Pb__1->SetBinError(4,0.01189807);
   hMR_Pb__1->SetBinError(5,0.0156023);
   hMR_Pb__1->SetBinError(6,0.0188007);
   hMR_Pb__1->SetBinError(7,0.02481805);
   hMR_Pb__1->SetEntries(5823.954);
