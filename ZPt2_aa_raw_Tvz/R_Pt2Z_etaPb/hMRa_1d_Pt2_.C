...
//=========  (Thu Jun 21 18:46:31 2018) by ROOT version 6.12/06
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(-0.1875,0.2633136,1.6875,1.107106);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Pb__1->SetBinContent(1,0.3816202);
   hMR_Pb__1->SetBinContent(2,0.4496595);
   hMR_Pb__1->SetBinContent(3,0.5197478);
   hMR_Pb__1->SetBinContent(4,0.6519842);
   hMR_Pb__1->SetBinContent(5,0.7609696);
   hMR_Pb__1->SetBinContent(6,0.8884127);
   hMR_Pb__1->SetBinContent(7,0.7554905);
   hMR_Pb__1->SetBinError(1,0.003313572);
   hMR_Pb__1->SetBinError(2,0.007606209);
   hMR_Pb__1->SetBinError(3,0.01628076);
   hMR_Pb__1->SetBinError(4,0.0341841);
   hMR_Pb__1->SetBinError(5,0.06036796);
   hMR_Pb__1->SetBinError(6,0.1021694);
   hMR_Pb__1->SetBinError(7,0.1191953);
   hMR_Pb__1->SetEntries(652.1516);
