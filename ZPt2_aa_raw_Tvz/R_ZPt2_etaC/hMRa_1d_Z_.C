...
//=========  (Thu Jun 21 18:46:00 2018) by ROOT version 6.12/06
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.2125,0.6639757,1.0875,0.8409877);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C__1->SetBinContent(1,0.8086512);
   hMR_C__1->SetBinContent(2,0.7745626);
   hMR_C__1->SetBinContent(3,0.7548254);
   hMR_C__1->SetBinContent(4,0.7575018);
   hMR_C__1->SetBinContent(5,0.7036007);
   hMR_C__1->SetBinContent(6,0.7334679);
   hMR_C__1->SetBinContent(7,0.7427672);
   hMR_C__1->SetBinError(1,0.007891915);
   hMR_C__1->SetBinError(2,0.007647056);
   hMR_C__1->SetBinError(3,0.008932743);
   hMR_C__1->SetBinError(4,0.01183603);
   hMR_C__1->SetBinError(5,0.01550153);
   hMR_C__1->SetBinError(6,0.02310229);
   hMR_C__1->SetBinError(7,0.03427046);
   hMR_C__1->SetEntries(12157.32);
   hMR_C__1->SetStats(0);
