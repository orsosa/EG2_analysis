...
//=========  (Thu Jun 21 18:41:44 2018) by ROOT version 6.12/06
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.2125,0.6633209,1.0875,0.8787372);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C__1->SetBinContent(1,0.8260515);
   hMR_C__1->SetBinContent(2,0.8240425);
   hMR_C__1->SetBinContent(3,0.8070646);
   hMR_C__1->SetBinContent(4,0.814221);
   hMR_C__1->SetBinContent(5,0.8229671);
   hMR_C__1->SetBinContent(6,0.8125887);
   hMR_C__1->SetBinContent(7,0.7366242);
   hMR_C__1->SetBinError(1,0.007981549);
   hMR_C__1->SetBinError(2,0.01063078);
   hMR_C__1->SetBinError(3,0.01430762);
   hMR_C__1->SetBinError(4,0.0197222);
   hMR_C__1->SetBinError(5,0.02602209);
   hMR_C__1->SetBinError(6,0.0325621);
   hMR_C__1->SetBinError(7,0.0439462);
   hMR_C__1->SetEntries(7174.826);
   hMR_C__1->SetStats(0);
