...
//=========  (Thu Jun 21 18:46:01 2018) by ROOT version 6.12/06
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.2125,0.4711444,1.0875,0.6166398);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Fe__1->SetBinContent(1,0.5917758);
   hMR_Fe__1->SetBinContent(2,0.5487293);
   hMR_Fe__1->SetBinContent(3,0.5242909);
   hMR_Fe__1->SetBinContent(4,0.521134);
   hMR_Fe__1->SetBinContent(5,0.5263616);
   hMR_Fe__1->SetBinContent(6,0.5053854);
   hMR_Fe__1->SetBinContent(7,0.5373691);
   hMR_Fe__1->SetBinError(1,0.004771785);
   hMR_Fe__1->SetBinError(2,0.004589941);
   hMR_Fe__1->SetBinError(3,0.005373213);
   hMR_Fe__1->SetBinError(4,0.007215296);
   hMR_Fe__1->SetBinError(5,0.01006685);
   hMR_Fe__1->SetBinError(6,0.01441278);
   hMR_Fe__1->SetBinError(7,0.02347161);
   hMR_Fe__1->SetEntries(14318.65);
