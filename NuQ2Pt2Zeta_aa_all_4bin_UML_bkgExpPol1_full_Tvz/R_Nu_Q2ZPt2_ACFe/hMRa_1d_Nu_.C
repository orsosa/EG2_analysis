...
//=========  (Mon May  7 20:51:27 2018) by ROOT version 6.12/04
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(1.9375,-0.05167597,4.5625,1.895826);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Fe__1->SetBinContent(1,0.6783664);
   hMR_Fe__1->SetBinContent(2,0.7429254);
   hMR_Fe__1->SetBinContent(3,0.4300733);
   hMR_Fe__1->SetBinContent(4,1.163245);
   hMR_Fe__1->SetBinError(1,0.1106042);
   hMR_Fe__1->SetBinError(2,0.2329455);
   hMR_Fe__1->SetBinError(3,0.2163413);
   hMR_Fe__1->SetBinError(4,0.4636411);
   hMR_Fe__1->SetEntries(27.68468);
