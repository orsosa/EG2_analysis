...
//=========  (Mon May  7 20:51:28 2018) by ROOT version 6.12/04
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(1.9375,0.04012163,4.5625,1.170519);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Pb__1->SetBinContent(1,0.3368157);
   hMR_Pb__1->SetBinContent(2,0.572896);
   hMR_Pb__1->SetBinContent(3,0.3979467);
   hMR_Pb__1->SetBinContent(4,0.7770322);
   hMR_Pb__1->SetBinError(1,0.06707259);
   hMR_Pb__1->SetBinError(2,0.0965233);
   hMR_Pb__1->SetBinError(3,0.2037731);
   hMR_Pb__1->SetBinError(4,0.2373846);
   hMR_Pb__1->SetEntries(38.91054);
