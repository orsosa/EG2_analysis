...
//=========  (Mon May  7 20:51:21 2018) by ROOT version 6.12/04
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(1.9375,0.209404,4.5625,0.8317135);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Pb__1->SetBinContent(1,0.3379699);
   hMR_Pb__1->SetBinContent(2,0.5536958);
   hMR_Pb__1->SetBinContent(3,0.5328213);
   hMR_Pb__1->SetBinContent(4,0.5782418);
   hMR_Pb__1->SetBinError(1,0.04375683);
   hMR_Pb__1->SetBinError(2,0.06969975);
   hMR_Pb__1->SetBinError(3,0.06897155);
   hMR_Pb__1->SetBinError(4,0.1675337);
   hMR_Pb__1->SetEntries(101.2927);
