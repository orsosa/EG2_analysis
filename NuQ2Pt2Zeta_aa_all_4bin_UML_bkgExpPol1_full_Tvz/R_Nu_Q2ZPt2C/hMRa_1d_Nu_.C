...
//=========  (Mon May  7 20:51:20 2018) by ROOT version 6.12/04
   ...
   c->Range(1.9375,0.7017021,4.5625,1.216919);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C__1->SetBinContent(1,0.8791154);
   hMR_C__1->SetBinContent(2,0.8483843);
   hMR_C__1->SetBinContent(3,1.035994);
   hMR_C__1->SetBinContent(4,1.019972);
   hMR_C__1->SetBinError(1,0.08492366);
   hMR_C__1->SetBinError(2,0.07646787);
   hMR_C__1->SetBinError(3,0.1097759);
   hMR_C__1->SetBinError(4,0.1165606);
   hMR_C__1->SetEntries(369.9204);
   hMR_C__1->SetStats(0);
