...
//=========  (Mon May  7 20:51:26 2018) by ROOT version 6.12/04
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(1.9375,0.1574494,4.5625,1.803254);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C__1->SetBinContent(1,0.8761129);
   hMR_C__1->SetBinContent(2,0.8778032);
   hMR_C__1->SetBinContent(3,0.7737501);
   hMR_C__1->SetBinContent(4,1.370623);
   hMR_C__1->SetBinError(1,0.1572742);
   hMR_C__1->SetBinError(2,0.1261859);
   hMR_C__1->SetBinError(3,0.3920085);
   hMR_C__1->SetBinError(4,0.2053538);
   hMR_C__1->SetEntries(64.25679);
   hMR_C__1->SetStats(0);
