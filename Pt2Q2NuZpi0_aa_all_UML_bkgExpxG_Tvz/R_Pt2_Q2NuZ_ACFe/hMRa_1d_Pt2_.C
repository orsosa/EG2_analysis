...
//=========  (Thu Apr 26 16:42:33 2018) by ROOT version 6.12/04
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(-0.1875,0.5683138,1.6875,0.7286916);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Fe__1->SetBinContent(1,0.6044169);
   hMR_Fe__1->SetBinContent(2,0.6104189);
   hMR_Fe__1->SetBinContent(3,0.648068);
   hMR_Fe__1->SetBinContent(4,0.6640258);
   hMR_Fe__1->SetBinContent(5,0.6026682);
   hMR_Fe__1->SetBinContent(6,0.6896446);
   hMR_Fe__1->SetBinError(1,0.01186982);
   hMR_Fe__1->SetBinError(2,0.01568291);
   hMR_Fe__1->SetBinError(3,0.01222534);
   hMR_Fe__1->SetBinError(4,0.0176948);
   hMR_Fe__1->SetBinError(5,0.01249787);
   hMR_Fe__1->SetBinError(6,0.01689954);
   hMR_Fe__1->SetEntries(11296.92);
