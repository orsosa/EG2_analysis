...
//=========  (Wed Apr 25 01:27:42 2018) by ROOT version 6.12/04
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(-0.1875,0.5729813,1.6875,0.6963449);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Fe__1->SetBinContent(1,0.5960779);
   hMR_Fe__1->SetBinContent(2,0.6228487);
   hMR_Fe__1->SetBinContent(3,0.6057421);
   hMR_Fe__1->SetBinContent(4,0.6386192);
   hMR_Fe__1->SetBinContent(5,0.6057079);
   hMR_Fe__1->SetBinContent(6,0.6704022);
   hMR_Fe__1->SetBinError(1,0.006284389);
   hMR_Fe__1->SetBinError(2,0.009525437);
   hMR_Fe__1->SetBinError(3,0.006156064);
   hMR_Fe__1->SetBinError(4,0.009388763);
   hMR_Fe__1->SetBinError(5,0.006455821);
   hMR_Fe__1->SetBinError(6,0.008906808);
   hMR_Fe__1->SetEntries(37062.69);
