...
//=========  (Wed Apr 25 01:27:41 2018) by ROOT version 6.12/04
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(-0.1875,0.7964579,1.6875,0.90685);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C__1->SetBinContent(1,0.8318224);
   hMR_C__1->SetBinContent(2,0.8433217);
   hMR_C__1->SetBinContent(3,0.8283857);
   hMR_C__1->SetBinContent(4,0.875232);
   hMR_C__1->SetBinContent(5,0.822761);
   hMR_C__1->SetBinContent(6,0.8606253);
   hMR_C__1->SetBinError(1,0.01113266);
   hMR_C__1->SetBinError(2,0.01638757);
   hMR_C__1->SetBinError(3,0.01064076);
   hMR_C__1->SetBinError(4,0.01637343);
   hMR_C__1->SetBinError(5,0.01125878);
   hMR_C__1->SetBinError(6,0.01423443);
   hMR_C__1->SetEntries(23228.55);
   hMR_C__1->SetStats(0);
