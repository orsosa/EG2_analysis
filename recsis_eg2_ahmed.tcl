...
setc chist_filename rs_ahmed_out/recsis_ahmed.hbook;
setc log_file_name rs_ahmed_out/recsis_logfile_ahmed.log;

setc outbanknames(1) "TRGSHEADPARTTBIDHEVTEVNTDCPBCCPBSCPBECPBCALLTBERTRKSTBTRSCRCCL01LCPBBMPREPICVERTMVRTTGBIHLSMCTKMCVX";

outputfile rs_ahmed_out/recsis_ahmed.bos PROC1 2047;
