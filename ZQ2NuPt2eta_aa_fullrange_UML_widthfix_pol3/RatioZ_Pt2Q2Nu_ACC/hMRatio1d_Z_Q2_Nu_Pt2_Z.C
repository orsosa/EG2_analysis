...
//=========  (Tue Feb 27 01:53:22 2018) by ROOT version5.34/34
   ...
   c->Range(0.325,-0.2672825,1.075,1.693609);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C->SetBinContent(1,1.512488e-06);
   hMR_C->SetBinContent(2,1.338103);
   hMR_C->SetBinContent(3,1.288727);
   hMR_C->SetBinContent(4,1.337976);
   hMR_C->SetBinContent(5,1.236704);
   hMR_C->SetBinContent(6,1.116628);
   hMR_C->SetBinError(1,5.137736e-05);
   hMR_C->SetBinError(2,0.084717);
   hMR_C->SetBinError(3,0.07739574);
   hMR_C->SetBinError(4,0.08242465);
   hMR_C->SetBinError(5,0.08769193);
   hMR_C->SetBinError(6,0.1012498);
   hMR_C->SetEntries(4.978776);
   hMR_C->SetStats(0);
