...
//=========  (Tue Feb 27 01:53:11 2018) by ROOT version5.34/34
   ...
   c->Range(0.325,0.7215692,1.075,1.00614);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C->SetBinContent(1,0.8986383);
   hMR_C->SetBinContent(2,0.827435);
   hMR_C->SetBinContent(3,0.9426659);
   hMR_C->SetBinContent(4,0.9384092);
   hMR_C->SetBinContent(5,0.7869432);
   hMR_C->SetBinContent(6,0.8329864);
   hMR_C->SetBinError(1,0.01943731);
   hMR_C->SetBinError(2,0.01866733);
   hMR_C->SetBinError(3,0.02417625);
   hMR_C->SetBinError(4,0.02838637);
   hMR_C->SetBinError(5,0.0265923);
   hMR_C->SetBinError(6,0.03558975);
   hMR_C->SetEntries(5.97265);
   hMR_C->SetStats(0);
