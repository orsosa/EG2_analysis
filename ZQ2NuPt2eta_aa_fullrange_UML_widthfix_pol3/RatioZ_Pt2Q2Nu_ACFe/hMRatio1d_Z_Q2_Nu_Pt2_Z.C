...
//=========  (Tue Feb 27 01:53:20 2018) by ROOT version5.34/34
   ...
   c->Range(0.325,-0.2115492,1.075,1.340455);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Fe->SetBinContent(1,1.220725e-06);
   hMR_Fe->SetBinContent(2,1.060535);
   hMR_Fe->SetBinContent(3,0.7886103);
   hMR_Fe->SetBinContent(4,0.70066);
   hMR_Fe->SetBinContent(5,0.8658652);
   hMR_Fe->SetBinContent(6,0.7496995);
   hMR_Fe->SetBinError(1,4.14665e-05);
   hMR_Fe->SetBinError(2,0.06559481);
   hMR_Fe->SetBinError(3,0.0459987);
   hMR_Fe->SetBinError(4,0.04171508);
   hMR_Fe->SetBinError(5,0.05902197);
   hMR_Fe->SetBinError(6,0.06642667);
   hMR_Fe->SetEntries(4.888326);
   hMR_Fe->SetStats(0);
