...
//=========  (Mon Jun 18 23:10:29 2018) by ROOT version 6.12/06
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.2125,0.342019,1.0875,0.5436372);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Pb__1->SetBinContent(1,0.5067618);
   hMR_Pb__1->SetBinContent(2,0.4588782);
   hMR_Pb__1->SetBinContent(3,0.4867481);
   hMR_Pb__1->SetBinContent(4,0.4707121);
   hMR_Pb__1->SetBinContent(5,0.4835222);
   hMR_Pb__1->SetBinContent(6,0.3847);
   hMR_Pb__1->SetBinError(1,0.009032946);
   hMR_Pb__1->SetBinError(2,0.009778081);
   hMR_Pb__1->SetBinError(3,0.01246281);
   hMR_Pb__1->SetBinError(4,0.0152169);
   hMR_Pb__1->SetBinError(5,0.01733092);
   hMR_Pb__1->SetBinError(6,0.01520417);
   hMR_Pb__1->SetEntries(7111.557);
