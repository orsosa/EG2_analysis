...
//=========  (Wed Jun 20 02:21:54 2018) by ROOT version 6.12/06
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.2125,0.6702495,1.0875,0.9829567);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C__1->SetBinContent(1,0.8439989);
   hMR_C__1->SetBinContent(2,0.8623896);
   hMR_C__1->SetBinContent(3,0.8347247);
   hMR_C__1->SetBinContent(4,0.8562301);
   hMR_C__1->SetBinContent(5,0.9007584);
   hMR_C__1->SetBinContent(6,0.7434454);
   hMR_C__1->SetBinError(1,0.02229048);
   hMR_C__1->SetBinError(2,0.02374078);
   hMR_C__1->SetBinError(3,0.02647877);
   hMR_C__1->SetBinError(4,0.03075207);
   hMR_C__1->SetBinError(5,0.0390149);
   hMR_C__1->SetBinError(6,0.03057975);
   hMR_C__1->SetEntries(4921.437);
   hMR_C__1->SetStats(0);
