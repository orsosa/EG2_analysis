...
//=========  (Mon Jun 18 23:10:27 2018) by ROOT version 6.12/06
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.2125,0.7263492,1.0875,0.9404055);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C__1->SetBinContent(1,0.8424874);
   hMR_C__1->SetBinContent(2,0.8796022);
   hMR_C__1->SetBinContent(3,0.8702152);
   hMR_C__1->SetBinContent(4,0.8649098);
   hMR_C__1->SetBinContent(5,0.8832003);
   hMR_C__1->SetBinContent(6,0.7776128);
   hMR_C__1->SetBinError(1,0.0124187);
   hMR_C__1->SetBinError(2,0.01350608);
   hMR_C__1->SetBinError(3,0.0179576);
   hMR_C__1->SetBinError(4,0.02161116);
   hMR_C__1->SetBinError(5,0.02764504);
   hMR_C__1->SetBinError(6,0.02209174);
   hMR_C__1->SetEntries(11013.15);
   hMR_C__1->SetStats(0);
