...
//=========  (Wed Jun 20 02:21:57 2018) by ROOT version 6.12/06
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.2125,0.4766825,1.0875,0.700806);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Fe__1->SetBinContent(1,0.6544801);
   hMR_Fe__1->SetBinContent(2,0.6349242);
   hMR_Fe__1->SetBinContent(3,0.6067115);
   hMR_Fe__1->SetBinContent(4,0.6078036);
   hMR_Fe__1->SetBinContent(5,0.6436505);
   hMR_Fe__1->SetBinContent(6,0.5260461);
   hMR_Fe__1->SetBinError(1,0.0153756);
   hMR_Fe__1->SetBinError(2,0.01616367);
   hMR_Fe__1->SetBinError(3,0.01657063);
   hMR_Fe__1->SetBinError(4,0.01852985);
   hMR_Fe__1->SetBinError(5,0.02305712);
   hMR_Fe__1->SetBinError(6,0.01881978);
   hMR_Fe__1->SetEntries(6742.908);
