...
//=========  (Thu May 10 16:33:31 2018) by ROOT version 6.12/04
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(-0.1875,0.5089709,1.6875,0.7329918);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Fe__1->SetBinContent(1,0.5491879);
   hMR_Fe__1->SetBinContent(2,0.6459085);
   hMR_Fe__1->SetBinContent(3,0.667665);
   hMR_Fe__1->SetBinContent(4,0.6768322);
   hMR_Fe__1->SetBinContent(5,0.6391823);
   hMR_Fe__1->SetBinContent(6,0.6882527);
   hMR_Fe__1->SetBinError(1,0.009687188);
   hMR_Fe__1->SetBinError(2,0.01374754);
   hMR_Fe__1->SetBinError(3,0.01148176);
   hMR_Fe__1->SetBinError(4,0.01453747);
   hMR_Fe__1->SetBinError(5,0.01177913);
   hMR_Fe__1->SetBinError(6,0.01380292);
   hMR_Fe__1->SetEntries(15654.06);
