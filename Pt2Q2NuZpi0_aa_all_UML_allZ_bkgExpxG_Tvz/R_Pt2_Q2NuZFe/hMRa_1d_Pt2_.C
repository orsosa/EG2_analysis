...
//=========  (Thu May 10 16:33:17 2018) by ROOT version 6.12/04
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(-0.1875,0.5933779,1.6875,0.6922364);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Fe__1->SetBinContent(1,0.6130101);
   hMR_Fe__1->SetBinContent(2,0.6481674);
   hMR_Fe__1->SetBinContent(3,0.6276779);
   hMR_Fe__1->SetBinContent(4,0.6521036);
   hMR_Fe__1->SetBinContent(5,0.6494649);
   hMR_Fe__1->SetBinContent(6,0.6712532);
   hMR_Fe__1->SetBinError(1,0.006159723);
   hMR_Fe__1->SetBinError(2,0.008063813);
   hMR_Fe__1->SetBinError(3,0.006133336);
   hMR_Fe__1->SetBinError(4,0.00778737);
   hMR_Fe__1->SetBinError(5,0.006344048);
   hMR_Fe__1->SetBinError(6,0.007331265);
   hMR_Fe__1->SetEntries(50512.9);
