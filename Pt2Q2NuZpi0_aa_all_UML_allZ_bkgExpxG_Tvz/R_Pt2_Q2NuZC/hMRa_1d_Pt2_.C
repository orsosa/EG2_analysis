...
//=========  (Thu May 10 16:33:17 2018) by ROOT version 6.12/04
   ...
   c->Range(-0.1875,0.8022652,1.6875,0.9079008);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_C__1->SetBinContent(1,0.8631103);
   hMR_C__1->SetBinContent(2,0.8433898);
   hMR_C__1->SetBinContent(3,0.847897);
   hMR_C__1->SetBinContent(4,0.8792374);
   hMR_C__1->SetBinContent(5,0.8276591);
   hMR_C__1->SetBinContent(6,0.8376877);
   hMR_C__1->SetBinError(1,0.01168364);
   hMR_C__1->SetBinError(2,0.01393247);
   hMR_C__1->SetBinError(3,0.01099491);
   hMR_C__1->SetBinError(4,0.01407564);
   hMR_C__1->SetBinError(5,0.01099768);
   hMR_C__1->SetBinError(6,0.01170689);
   hMR_C__1->SetEntries(28645.51);
   hMR_C__1->SetStats(0);
