...
//=========  (Thu May 10 16:33:18 2018) by ROOT version 6.12/04
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(-0.1875,0.4352014,1.6875,0.5516944);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Pb__1->SetBinContent(1,0.473868);
   hMR_Pb__1->SetBinContent(2,0.5254366);
   hMR_Pb__1->SetBinContent(3,0.4847982);
   hMR_Pb__1->SetBinContent(4,0.5040124);
   hMR_Pb__1->SetBinContent(5,0.4588181);
   hMR_Pb__1->SetBinContent(6,0.4907405);
   hMR_Pb__1->SetBinError(1,0.007707333);
   hMR_Pb__1->SetBinError(2,0.01017069);
   hMR_Pb__1->SetBinError(3,0.007696079);
   hMR_Pb__1->SetBinError(4,0.01011105);
   hMR_Pb__1->SetBinError(5,0.007740971);
   hMR_Pb__1->SetBinError(6,0.008419475);
   hMR_Pb__1->SetEntries(18961.92);
