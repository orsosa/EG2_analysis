...
//=========  (Wed Jun 20 22:16:53 2018) by ROOT version 6.12/06
   ...
   c1->Range(0.4166667,-9939.523,1.083333,89455.7);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetTickx(1);
   ...
   hzl__1->SetBinContent(1,75455);
   hzl__1->SetBinContent(2,45662);
   hzl__1->SetBinContent(3,25221);
   hzl__1->SetBinContent(4,18366);
   hzl__1->SetBinError(1,274.6907);
   hzl__1->SetBinError(2,213.6867);
   hzl__1->SetBinError(3,158.8112);
   hzl__1->SetBinError(4,135.5212);
   hzl__1->SetEntries(164704);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = 0.6408");
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.1138");
   ...
   hzs__2->SetBinContent(1,47519);
   hzs__2->SetBinContent(2,28128);
   hzs__2->SetBinContent(3,15238);
   hzs__2->SetBinContent(4,11178);
   hzs__2->SetBinError(1,217.9885);
   hzs__2->SetBinError(2,167.714);
   hzs__2->SetBinError(3,123.4423);
   hzs__2->SetBinError(4,105.7261);
   hzs__2->SetEntries(102063);
